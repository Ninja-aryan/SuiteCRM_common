                            ...
                            if (typeof result != 'undefined') {
                                ...
                                for (var x = 0; x < result['updates'].length; x++) {
                                    ...
                                    if (result['updates'][x]['type'] == 'patch') {
                                        tmpNodeRelease.onCheckClick = function () {
                                            this.uncheck();
                                            if (confirm('{/literal}{$MOD.MI_REDIRECT_TO_UPGRADE_WIZARD}{literal}')) {
                                                location.href = '{/literal}{$UPGARDE_WIZARD_URL}{literal}'
                                            }
                                        };
                                    } else {
                                        tmpNodeRelease.onCheckClick = function () {
    ...
    PackageManagerGrid = function () {
        ...
        _fileGrid = new YAHOO.widget.ScrollingDataTable(
            ...
            [
                {
                    key: 'name',
                    label: '{/literal}{$ML_FILEGRID_COLUMN.Name}{literal}',
                ...
                {
                    key: 'file',
                    label: '{/literal}{$ML_FILEGRID_COLUMN.Install}{literal}',
                    minWidth: Math.round(patch_downloads_minWidth / 1.5),
                ...
                {
                    key: 'unFile',
                    label: '{/literal}{$ML_FILEGRID_COLUMN.Delete}{literal}',
                ...
                {
                    key: 'type',
                    label: '{/literal}{$ML_FILEGRID_COLUMN.Type}{literal}',
                    minWidth: Math.round(patch_downloads_minWidth / 1.5)
                },
                {
                    key: 'version',
                    label: '{/literal}{$ML_FILEGRID_COLUMN.Version}{literal}',
                    minWidth: Math.round(patch_downloads_minWidth)
                },
                {
                    key: 'date',
                    label: '{/literal}{$ML_FILEGRID_COLUMN.Published}{literal}',
                    minWidth: Math.round(patch_downloads_minWidth)
                },
                {
                    key: 'uninstallable',
                    label: '{/literal}{$ML_FILEGRID_COLUMN.Uninstallable}{literal}',
                    minWidth: Math.round(patch_downloads_minWidth / 1.5)
                },
                {
                    key: 'description',
                    label: '{/literal}{$ML_FILEGRID_COLUMN.Description}{literal}',
                    minWidth: Math.round(patch_downloads_minWidth * 1.5),
                    sortable: true
                }
            ],
        ...
        _fileGridInstalled = new YAHOO.widget.ScrollingDataTable('installed_grid',
            [
                {
                    key: 'name',
                    label: '{/literal}{$ML_FILEGRIDINSTALLED_COLUMN.Name}{literal}',
                    sortable: true,
                    'minWidth': Math.round(minWidth * 1.5)
                },
                {
                    key: 'unFile',
                    label: '{/literal}{$ML_FILEGRIDINSTALLED_COLUMN.Action}{literal}',
                    formatter: this.renderUninstallButton,
                    'minWidth': Math.round(minWidth / 1.5)
                },
                {
                    key: 'state_file',
                    label: '{/literal}{$ML_FILEGRIDINSTALLED_COLUMN.Enable_Or_Disable}{literal}',
                    formatter: this.renderEnableDisableButton,
                    'minWidth': Math.round(minWidth / 1.5)
                },
                {
                    key: 'type',
                    label: '{/literal}{$ML_FILEGRIDINSTALLED_COLUMN.Type}{literal}',
                    'minWidth': Math.round(minWidth / 1.5)
                },
                {
                    key: 'version',
                    label: '{/literal}{$ML_FILEGRIDINSTALLED_COLUMN.Version}{literal}',
                    'minWidth': Math.round(minWidth)
                },
                {
                    key: 'date',
                    label: '{/literal}{$ML_FILEGRIDINSTALLED_COLUMN.Date_Installed}{literal}',
                    'minWidth': Math.round(minWidth)
                },
                {
                    key: 'description',
                    label: '{/literal}{$ML_FILEGRIDINSTALLED_COLUMN.Description}{literal}',
                    sortable: true,
                    'minWidth': Math.round(minWidth * 1.5)
                }
            ],
        ...
        _fileGrid = new YAHOO.ext.grid.DDGrid(
            ...
            new YAHOO.ext.grid.DefaultColumnModel([
                ...
                {
                    label: '{/literal}{$ML_FILEGRID_COLUMN.Build}{literal}',
                    width: 80,
                    sortable: true,
                    sortType: sort.asUCString
                },
