        ...
        <tr>
            <td align="left" style="padding-bottom: 2px;">
                <input title="{$APP.LBL_SAVE_BUTTON_TITLE}" accessKey="{$APP.LBL_SAVE_BUTTON_KEY}" class="button"
                       type="submit"
                       name="button" {$saveOnclick|default:"onclick=\"return check_form('ProjectTaskQuickCreate');\""}
                ...
                <input title="{$APP.LBL_FULL_FORM_BUTTON_TITLE}" accessKey="{$APP.LBL_FULL_FORM_BUTTON_KEY}"
                       ...
                       onclick="this.form.to_pdf.value='0';this.form.action.value='EditView'; this.form.module.value='ProjectTask';"
        ...
        <tr>
            <td>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <th align="left" scope="row" colspan="4"><h4><span>{$MOD.LBL_PROJECTTYPE_INFORMATION}</span>
                            </h4></th>
                    </tr>
                    <tr>
                        <td valign="top" scope="row"><span>{$MOD.LBL_NAME} <span
                                        class="required">{$APP.LBL_REQUIRED_SYMBOL}</span></span></td>
                        <td><span><input name="name" tabindex="1" size="35" maxlength="50" type="text" value=""></span>
                        </td>
                        <td colspan="2">&nbsp;</td>
                    </tr>
                    <tr>
                        <td valign="top" scope="row" rowspan="2"><span>{$MOD.LBL_DESCRIPTION}</span></td>
                        <td rowspan="2"><span><textarea name='description' tabindex='3' cols="50"
                    ...
                    <tr>
                        {if $REQUEST.project_id != ''}
                            ...
                            <td><span>{$REQUEST.parent_name}<input id='project_name' name='project_name' type="hidden"
                                                                   value='{$REQUEST.parent_name}'><input id='project_id'
                                                                                                         name='project_id'
                                                                                                         type="hidden"
                                                                                                         value='{$REQUEST.project_id}'>&nbsp;</span>
                            </td>
                        {else}
                            <td scope="row"><span>{$MOD.LBL_PARENT_ID}</span></td>
                            <td><span><input type="text" class="sqsEnabled" tabindex="2" autocomplete="off"
                                             name="parent_name" id="parent_name"
                                             value="{$parent_name}" tabindex="16"/><input type="hidden"
                                                                                          name="project_id"
                                                                                          id="project_id"
