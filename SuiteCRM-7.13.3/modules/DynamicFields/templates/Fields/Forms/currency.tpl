    ...
    <td>
        {if $hideLevel < 5}
            <input type='text' id='default' name='default'
                   value='{sugar_currency_format var=$vardef.default currency_symbol=false}'>
            <script>
        ...
        {else}
            <input type='hidden' name='default'
                   value='{sugar_currency_format var=$vardef.default currency_symbol=false}'>
            {sugar_currency_format var=$vardef.default}
        {/if}
    </td>
</tr>{include file="modules/DynamicFields/templates/Fields/Forms/coreBottom.tpl"}