    ...
    <form name='configure_{$id}' action="index.php" method="post"
        ...
        <table width="400" cellpadding="0" cellspacing="0" border="0" class="edit view" align="center">
            ...
            <tr>
                ...
                <td valign='top' class='dataField'>
                    <input onblur="parseDate(this, '{$cal_dateformat}');" type="text" class="text"
                           name="pbss_date_start" size='12' maxlength='10' id='date_start' value='{$date_start}'>
            ...
            <tr>
                ...
                <td valign='top' class='dataField'>
                    <input onblur="parseDate(this, '{$cal_dateformat}');" type="text" class="text" name="pbss_date_end"
                           size='12' maxlength='10' id='date_end' value='{$date_end}'>
