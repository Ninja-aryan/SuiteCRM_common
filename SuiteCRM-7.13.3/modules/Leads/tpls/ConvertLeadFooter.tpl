...
{if $lead_conv_activity_opt == 'move'}
    <table width="100%" border="0" cellspacing="1" cellpadding="0"
           class="{$def.templateMeta.panelClass|default:'edit view'}" id="lead_conv_ac_op">
        <tr>
            <td width="15%" class="rssItemDate">
                {sugar_translate label='LBL_ACTIVITIES_MOVE' module='Leads'}
                :&nbsp;{sugar_help text=$MOD.LBL_ACTIVITIES_MOVE_HELP}
            </td>
            <td>
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="0"
        ...
        <tr>
            <td width="15%" class="rssItemDate">
                ...
                :&nbsp;{sugar_help text=$MOD.LBL_ACTIVITIES_COPY_HELP}
            </td>
            <td>
        ...
        <td class="buttons">
            {if $bean->aclAccess("save")}
                <input title='{sugar_translate label="LBL_SAVE_BUTTON_LABEL"}' class="button primary"
                       ...
                       type="submit" name="button" id="SAVE_FOOTER"
            ...
            {if !empty($smarty.request.return_action) && ($smarty.request.return_action == "DetailView" && !empty($record_id))}
                <input title="{sugar_translate label='LBL_CANCEL_BUTTON'}" class="button"
                       ...
                       type="submit" id="CANCEL_FOOTER" name="button"
                       value="{sugar_translate label='LBL_CANCEL_BUTTON_LABEL'}">
