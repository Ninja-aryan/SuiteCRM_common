    ...
    if (aow_field != '') {
        var callback = {
            success: function (result) {
                ...
                enableQS(false);
                document.getElementById('crLine' + ln + '_fieldType' + cln).onchange = function () {
                    show_crModuleFieldType(ln, cln);
                };
            },
    ...
    if (aow_field != '') {
        var callback = {
            success: function (result) {
                ...
                SUGAR.util.evalScript(result.responseText);
                enableQS(false);
                document.getElementById('crRelLine' + ln + '_fieldType' + cln).onchange = function () {
                    show_crRelFieldType(ln, cln);
                };
            },
            failure: function (result) {
