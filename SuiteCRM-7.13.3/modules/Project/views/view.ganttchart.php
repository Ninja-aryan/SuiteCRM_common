                            ...
                            <tr>
                                <td>
                                    ...
                                    <input type="hidden" name="consider_business_hours" id="consider_business_hours"
                                           value="<?php echo $project->override_business_hours; ?>">
                                    ...
                                    <label id="Milestone_label"
                                           for="Milestone"><?php echo $mod_strings['LBL_MILESTONE_FLAG']; ?></label>
                                    <label id="parent_task_id" for="parent_task"
                                           style="display: none; visibility: collapse;"><?php echo $mod_strings['LBL_PARENT_TASK_ID']; ?></label>
                                    ...
                                    <!-- <option value="Hours">--><?php //echo $mod_strings['LBL_HOURS'];
                                    ?><!--</option>-->
                                    </select>
