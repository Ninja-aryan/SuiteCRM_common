        ...
        <table>
            <tr>
                <td colspan="3">
                    ...
                    <input type="button" class="button" name="cancel" value="{$MOD.LBL_BTN_CANCEL}"
            ...
            <tr>
                <td><b>{$MOD.LBL_DROPDOWN_ITEM_NAME}</b><span class="fieldValue">[{$MOD.LBL_DROPDOWN_ITEM_LABEL}]<span>
                </td>
            </tr>
            <tr>
                <td colspan="3">
                            ...
                            <li class="draggable" id="{$name}">
			                   ...
			                   <input type="text" id="input_{$name}" value="{$val}"
                                      onBlur="SimpleList.setDropDownValue('{$name}', this.value, true)">
                                        ...
                                        <td align="right">
                                            <a class="editImage" href="javascript:void(0)"
                                               onclick="SimpleList.editDropDownValue('{$name}', true)"></a>
                                            &nbsp;
            ...
            <tr>
                <td colspan="3">
                    <table width="100%">
                        <tr>
                            <td class="mbLBLL">{$MOD.LBL_DROPDOWN_ITEM_NAME}:</td>
                            <td class="mbLBLL">{$MOD.LBL_DROPDOWN_ITEM_LABEL}:</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td><input type="button" id="dropdownaddbtn" value="{$APP.LBL_ADD_BUTTON}" class="button">
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td colspan="3">
                    <input type="button" class="button" value="{$MOD.LBL_BTN_SORT_ASCENDING}"
                           onclick="SimpleList.sortAscending()">
                    <input type="button" class="button" value="{$MOD.LBL_BTN_SORT_DESCENDING}"
