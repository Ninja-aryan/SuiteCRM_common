        ...
        <table style="width:auto;height:600px;" align="center">
            <tr>
                <td align="center">
                    ...
                    <form name="AdminWizard" id="AdminWizard" enctype='multipart/form-data' method="POST"
                                ...
                                <div id="system" class="screen">
                                            ...
                                            <td>
                                                <div class="edit view">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <th align="left" scope="row" colspan="4">
                                                                <h2>{$MOD.LBL_WIZARD_SYSTEM_TITLE}</h2></th>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" scope="row" colspan="4">
                                                                <i>{$MOD.LBL_WIZARD_SYSTEM_DESC}</i></td>
                                                        </tr>
                                                        <tr>
                                                            <td scope="row" width='15%' nowrap>{$MOD.SYSTEM_NAME_WIZARD}
                                                                &nbsp;{sugar_help text=$MOD.SYSTEM_NAME_HELP}</td>
                                                            <td width='35%'>
                                                        ...
                                                        <tr>
                                                            <td scope="row" width='12%' nowrap>{$MOD.NEW_LOGO}
                                                                &nbsp;{sugar_help text=$MOD.NEW_LOGO_HELP_NO_SPACE}
                                                            </td>
                                                            <td width='35%'>
                                                        ...
                                                        <tr>
                                                            <td scope="row" width='12%' nowrap>{$MOD.CURRENT_LOGO}
                                                                &nbsp;{sugar_help text=$MOD.CURRENT_LOGO_HELP}</td>
                                                            <td width='35%'>
                                                                <img id="company_logo_image" alt='{$MOD.LBL_LOGO}'
                                                                     src='{$company_logo}'/>
                                                            </td>
                                                        </tr>
                                                    </table>
                                    ...
                                    <div class="nav-buttons">
                                        ...
                                        <input title="{$MOD.LBL_WIZARD_NEXT_BUTTON}"
                                               ...
                                               value="  {$MOD.LBL_WIZARD_NEXT_BUTTON}  "
                                                {if $silentInstall}
                                               onclick="SugarWizard.changeScreen('scenarios',false);"
                                               id="next_tab_scenarios"/>
                                        {else}
                                            ...
                                            <td>
                                                <div class="edit view">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td align="left" scope="row" colspan="4">
                                                                <i>{$MOD.LBL_WIZARD_SCENARIOS_DESC}</i></td>
                                                        </tr>
                                                        {if $scenarios|@count > 0}
                                                            {foreach from=$scenarios item=item key=key}
                                                                <tr>
                                                                    <td scope="row" nowrap="nowrap">
                                                                        <span>{$item.title}:</span>&nbsp;{sugar_help text=$item.description}
                                                                    </td>
                                                                    <td colspan="3"><span><input type='checkbox'
                                                                                                 name='scenarios[]'
                                                                                                 value={$item.key} checked>  {$item.moduleOverview}</span>
                                                                    </td>
                                                                </tr>
                                                            {/foreach}
                                                        {else}
                                ...
                                <div id="locale" class="screen">
                                            ...
                                            <td>
                                                <div class="edit view">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <th align="left" scope="row" colspan="4">
                                                                <h2>{sugar_translate module='Administration' label='LBL_LOCALE_TITLE'}</h2>
                                                            </th>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" scope="row" colspan="4">
                                                        ...
                                                        <tr>
                                                            <td nowrap="nowrap" scope="row"
                                                                width="200">{sugar_translate module='Administration' label='LBL_LOCALE_DEFAULT_DATE_FORMAT'}
                                                                :
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td nowrap="nowrap" scope="row"
                                                                width="200">{sugar_translate module='Administration' label='LBL_LOCALE_DEFAULT_TIME_FORMAT'}
                                                                :
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td nowrap="nowrap"
                                                                scope="row">{sugar_translate module='Administration' label='LBL_LOCALE_DEFAULT_LANGUAGE'}
                                                                :
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td nowrap="nowrap" scope="row"
                                                                width="200">{sugar_translate module='Administration' label='LBL_LOCALE_DEFAULT_CURRENCY_NAME'}
                                                                :
                                                            </td>
                                                            <td>
                                                                <input type='text' size='15'
                                                                       name='default_currency_name'
                                                                       value='{$config.default_currency_name}'>
                                                            </td>
                                                            <td nowrap="nowrap" scope="row"
                                                                width="200">{sugar_translate module='Administration' label='LBL_LOCALE_DEFAULT_CURRENCY_SYMBOL'}
                                                                :
                                                            </td>
                                                            <td>
                                                                <input type='text' size='4'
                                                                       name='default_currency_symbol'
                                                                       value='{$config.default_currency_symbol}'>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td nowrap="nowrap" scope="row"
                                                                width="200">{sugar_translate module='Administration' label='LBL_LOCALE_DEFAULT_CURRENCY_ISO4217'}
                                                                :
                                                            </td>
                                                            <td>
                                                                <input type='text' size='4'
                                                                       name='default_currency_iso4217'
                                                                       value='{$config.default_currency_iso4217}'>
                                                            </td>
                                                            <td nowrap="nowrap"
                                                                scope="row">{sugar_translate module='Administration' label='LBL_LOCALE_DEFAULT_NUMBER_GROUPING_SEP'}
                                                                :
                                                            </td>
                                                            <td>
                                                                <input type='text' size='3' maxlength='1'
                                                                       name='default_number_grouping_seperator'
                                                                       value='{$config.default_number_grouping_seperator}'>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td nowrap="nowrap"
                                                                scope="row">{sugar_translate module='Administration' label='LBL_LOCALE_DEFAULT_DECIMAL_SEP'}
                                                                :
                                                            </td>
                                                            <td>
                                                                <input type='text' size='3' maxlength='1'
                                                                       name='default_decimal_seperator'
                                                                       value='{$config.default_decimal_seperator}'>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td nowrap="nowrap" scope="row"
                                                                valign="top">{sugar_translate module='Administration' label='LBL_LOCALE_DEFAULT_NAME_FORMAT'}
                                                                :
                                                            </td>
                                                            <td>
                                    ...
                                    <div class="nav-buttons">
                                        <input title="{$MOD.LBL_WIZARD_BACK_BUTTON}"
                                               ...
                                               value="  {$MOD.LBL_WIZARD_BACK_BUTTON}  "
                                                {if $silentInstall}
                                               onclick="SugarWizard.changeScreen('scenarios',true);"
                                               id="previous_tab_scenarios"/>&nbsp;
                                        {else}
                                            ...
                                            <td>
                                                <div class="edit view">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td align="left" scope="row" colspan="4">
                                                                <i>{$MOD.LBL_WIZARD_SMTP_DESC}</i></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" scope="row"
                                                                colspan="4">{$MOD.LBL_CHOOSE_EMAIL_PROVIDER}</td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="4">
                            ...
                            <span class="first-child">
                                <button type="button" name="mail_smtptype" value="other">
                                                                    ...
                                                                    <table width="100%" cellpadding="0" cellspacing="0">
                                                                        <tr id="mailsettings1">
                                                                            <td width="20%" scope="row"><span
                                                                                        id="mail_smtpserver_label">{$MOD.LBL_MAIL_SMTPSERVER}</span>
                                                                                <span class="required"
                                                                                      id="required_mail_smtpserver"></span>
                                                                            </td>
                                                                            <td width="20%" scope="row"><span
                                                                                        id="mail_smtpserver_label">{$MOD.LBL_MAIL_SMTPSERVER}</span>
                                                                                <span class="required"
                                                                            ...
                                                                            <td width="30%"><span><input type="text"
                                                                                                         id="mail_smtpserver"
                                                                                                         name="mail_smtpserver"
                                                                                                         tabindex="1"
                                                                                                         size="25"
                                                                                                         maxlength="255"
                                                                                                         value="{$mail_smtpserver}"></span>
                                                                            </td>
                                                                            <td width="20%" scope="row"><span
                                                                                        id="mail_smtpport_label">{$MOD.LBL_MAIL_SMTPPORT}</span>
                                                                            </td>
                                                                        ...
                                                                        <tr id="mailsettings2">
                                                                            <td width="20%" scope="row"><span
                                                                                        id='mail_smtpauth_req_label'>{$MOD.LBL_MAIL_SMTPAUTH_REQ}</span>
                                                                            </td>
                                                                            <td width="30%">
                                                                                <input id='mail_smtpauth_req'
                                                                                       name='mail_smtpauth_req'
                                                                                       type="checkbox" class="checkbox"
                                                                                       value="1" tabindex='1'
                                                                                       onclick="notify_setrequired();" {$mail_smtpauth_req}>
                                                                            </td>
                                                                            <td width="20%" scope="row" nowrap="nowrap">
                                                                                <span id="mail_smtpssl_label">{$APP.LBL_EMAIL_SMTP_SSL_OR_TLS}</span>
                                                                            </td>
                                                                            <td width="30%">
                                                                                <select id="mail_smtpssl"
                                                                                        name="mail_smtpssl"
                                                                                        onchange="setDefaultSMTPPort()"
                                                                                        tabindex="501">{$MAIL_SSL_OPTIONS}</select>
                                                                            </td>
                                                                        </tr>
                                                                        <tr id="smtp_auth1">
                                                                            <td width="20%" scope="row" nowrap="nowrap">
                                                                                <span id="mail_smtpuser_label">{$MOD.LBL_MAIL_SMTPUSER}</span>
                                                                        ...
                                                                        <tr id="smtp_auth2">
                                                                            <td width="20%" scope="row" nowrap="nowrap">
                                                                                <span id="mail_smtppass_label">{$MOD.LBL_MAIL_SMTPPASS}</span>
                                                                                <span class="required"></span></td>
                                                                            <td width="30%"><span><input type="password"
                                                                                                         id="mail_smtppass"
                                                                                                         name="mail_smtppass"
                                                                                                         size="25"
                                                                                                         maxlength="255"
                                   ...
                                   {sugar_help text=$MOD.LBL_ALLOW_DEFAULT_SELECTION_HELP }
                                                                            ...
                                                                            <td width="30%">
                                     <span>
                                     <input type="hidden" name="notify_allow_default_outbound"
                                            id="notify_allow_default_outbound_hidden_input" value="0">
                                     <input id='notify_allow_default_outbound' name='notify_allow_default_outbound'
                                            value="2" tabindex='1' class="checkbox"
                                            type="checkbox" {$notify_allow_default_outbound_on}>
                                     </span>
                                                                            </td>
                                                                            <td scope="row">&nbsp;</td>
                                                                            <td>&nbsp;</td>
                                                                        ...
                                                                        <tr>
                                                                            <td width="50%" cellspan="2" scope="row"
                                                                                nowrap>
                                    ...
                                    <div class="nav-buttons">
                                        ...
                                        <input title="{$MOD.LBL_WIZARD_CONTINUE_BUTTON}" class="button primary"
                                               onclick="if(adjustEmailSettings())this.form.submit();" type="button"
                                               name="continue" value="{$MOD.LBL_WIZARD_CONTINUE_BUTTON}"
                    ...
                    <div id='upload_panel' style="display:none">
                        <form id="upload_form" name="upload_form" method="POST" action='index.php'
                              enctype="multipart/form-data">
                            <input type="file" id="my_file_company" name="file_1" size="20"
                                   onchange="uploadCheck(false)"/>
