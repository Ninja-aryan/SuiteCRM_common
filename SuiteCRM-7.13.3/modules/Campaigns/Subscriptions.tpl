...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td colspan='100'><h2 class="header-2">{$title}</h2></td>
    </tr>
    <tr>
        <td colspan='100'>
            {$description}
        ...
        <td colspan='100'>
            ...
            <form name="ConfigureSubs" method="POST" method="POST" action="index.php">
                ...
                <form enctype="multipart/form-data" id="SubsForm" name="SubsForm" method="POST" action="index.php">
                    ...
                    <input type="hidden" name="orig_disabled_values" id="orig_disabled_values"
                           value="{$disabled_subs_string}">
                    <input type="hidden" name="orig_enabled_values" id="orig_enabled_values"
                           value="{$enabled_subs_string}">
                    ...
                    <div class='add_table' style='margin-bottom:5px'>
                        <table id="ConfigureSubs" class="themeSettings edit view" style='margin-bottom:0px;' border="0"
