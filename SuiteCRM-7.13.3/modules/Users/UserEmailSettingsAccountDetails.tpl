                    ...
                    <td valign="top" NOWRAP>
                        <div>
                            <table>
                                <tr>
                                    <td>
                                        <div id="outboundAccountsTable" class="yui-skin-sam"></div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    <td style="padding-bottom: 5px">
                                        <input id="outbound_email_add_button"
                                               title="{$app_strings.LBL_EMAIL_FOLDERS_ADD}" type='button'
                                               class="button" onClick='SUGAR.email2.accounts.showAddSmtp();'
                                               name="button" value="{$mod_strings.LBL_ADD_OUTBOUND_ACCOUNT}">
                                    </td>
                                </tr>
            ...
            <table cellpadding="4" cellspacing="0" border="0" width="100%" class="view">
                ...
                <tr>
                    <td colspan="4" scope="row">
                        <h4>{$app_strings.LBL_INCOMING_EMAIL}</h4>{$app_strings.LBL_EMAIL_ACCOUNTS_SUBTITLE}</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <div id="inboundAccountsTable" class="yui-skin-sam"></div>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
