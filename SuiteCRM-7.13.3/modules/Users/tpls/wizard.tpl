...
<div id="main">
    <div id="content">
        <table style="width:auto;height:600px;" align="center">
            <tr>
                <td align="center">

                    <form id="UserWizard" name="UserWizard" enctype='multipart/form-data' method="POST"
                          action="index.php" onkeypress="return disableReturnSubmission(event);">
                        ...
                        <script type="text/javascript"
                                src="{sugar_getjspath file='modules/Emails/javascript/vars.js'}"></script>
                        <script type="text/javascript"
                                src="{sugar_getjspath file='cache/include/javascript/sugar_grp_emails.js'}"></script>
                            ...
                            <div class="bd">
                                ...
                                <div id="welcome" class="screen">
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <th align="left" scope="row" colspan="4">
                                                                <h2>{$MOD.LBL_WIZARD_WELCOME_TITLE}</h2></th>
                                                        </tr>
                                                        <tr>
                                                            <td scope="row">
                                                                <p> {$MOD.LBL_WIZARD_WELCOME_NOSMTP}</p>
                                                                <div class="userWizWelcome"><img
                                                                            src='include/images/sugar_wizard_welcome.jpg'
                                                                            border='0'
                                                                            alt='{$MOD.LBL_WIZARD_WELCOME_TAB}'
                                    ...
                                    <div class="nav-buttons">
                                        <input title="{$MOD.LBL_WIZARD_NEXT_BUTTON}"
                                               class="button primary" type="button" name="next_tab1"
                                               value="  {$MOD.LBL_WIZARD_NEXT_BUTTON}  "
                                               onclick="SugarWizard.changeScreen('personalinfo',false);"
                                               id="next_tab_personalinfo"/>
                                    </div>
                                </div>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <th align="left" scope="row" colspan="4"><h2>
                                                                    <span>{$MOD.LBL_WIZARD_PERSONALINFO}</span></h2>
                                                            </th>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" scope="row" colspan="4">
                                                                <i>{$MOD.LBL_WIZARD_PERSONALINFO_DESC}</i></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="17%" scope="row" nowrap="nowrap">
                                                                <span>{$MOD.LBL_FIRST_NAME}:</span></td>
                                                            <td width="33%"><span><input id='first_name'
                                                                                         name='first_name' tabindex='1'
                                                                                         size='25' maxlength='25'
                                                                                         type="text"
                                                                                         value="{$FIRST_NAME}"></span>
                                                            </td>
                                                            <td width="17%" scope="row" nowrap="nowrap">
                                                                <span>{$MOD.LBL_LAST_NAME}: <span
                                                                            class="required">{$APP.LBL_REQUIRED_SYMBOL}</span></span>
                                                            </td>
                                                            <td width="33%"><span><input id='last_name' name='last_name'
                                                                                         tabindex='2' size='25'
                                                        ...
                                                        <tr>
                                                            <td scope="row" width="17%">
                                                                {$MOD.LBL_EMAIL}: {if $REQUIRED_EMAIL_ADDRESS}<span
                                                                        class="required">{$APP.LBL_REQUIRED_SYMBOL}</span>{/if}
                                                            </td>
                                                            <td width="33%"><span><input name='email1' tabindex='3'
                                                                                         size='30' maxlength='100'
                                                                                         value='{$EMAIL1}' id='email1'/></span>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td width="17%" scope="row" nowrap="nowrap">
                                                                <span>{$MOD.LBL_OFFICE_PHONE}:</span></td>
                                                            <td width="33%"><span><input name='phone_work' type="text"
                                                                                         tabindex='4' size='20'
                                                                                         maxlength='25'
                                                                                         value='{$PHONE_WORK}'></span>
                                                            </td>
                                                            <td scope="row" nowrap="nowrap">
                                                                <span>{$MOD.LBL_MESSENGER_TYPE}:</span></td>
                                                            <td><span>{$MESSENGER_TYPE_OPTIONS}</span></td>
                                                        </tr>
                                                        <tr>
                                                            <td scope="row"><span>{$MOD.LBL_MOBILE_PHONE}:</span></td>
                                                            <td><span><input name='phone_mobile' type="text"
                                                                             tabindex='6' size='20' maxlength='25'
                                                                             value='{$PHONE_MOBILE}'></span></td>
                                                            <td scope="row" nowrap="nowrap">
                                                                <span>{$MOD.LBL_MESSENGER_ID}:</span></td>
                                                            <td><span><input name='messenger_id' type="text"
                                                                             tabindex='6' size='30' maxlength='100'
                                                                             value='{$MESSENGER_ID}'></span></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="17%" scope="row" nowrap="nowrap">
                                                                <span>{$MOD.LBL_PRIMARY_ADDRESS}:</span></td>
                                                            <td width="33%"><span><textarea name='address_street'
                                                                                            rows="2" tabindex='8'
                                                                                            cols="30">{$ADDRESS_STREET}</textarea></span>
                                                            </td>
                                                            <td scope="row" nowrap="nowrap"><span>&nbsp;</span></td>
                                                            <td><span>&nbsp;</span></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="17%" scope="row" nowrap="nowrap">
                                                                <span>{$MOD.LBL_CITY}:</span></td>
                                                            <td width="33%"><span><input name='address_city'
                                                                                         tabindex='8' size='15'
                                                                                         maxlength='100'
                                                                                         value='{$ADDRESS_CITY}'></span>
                                                            </td>
                                                            <td scope="row" nowrap="nowrap">
                                                                <span>{$MOD.LBL_STATE}:</span></td>
                                                            <td><span><input name='address_state' tabindex='9' size='15'
                                                                             maxlength='100'
                                                                             value='{$ADDRESS_STATE}'></span></td>
                                                        </tr>
                                                        <tr>
                                                            <td scope="row" nowrap="nowrap"><span>{$MOD.LBL_POSTAL_CODE}:</span>
                                                            </td>
                                                            <td><span><input name='address_postalcode' tabindex='9'
                                                                             size='10' maxlength='20'
                                                                             value='{$ADDRESS_POSTALCODE}'></span></td>
                                                            <td scope="row" nowrap="nowrap">
                                                                <span>{$MOD.LBL_COUNTRY}:</span></td>
                                                            <td><span><input name='address_country' tabindex='10'
                                                                             size='10' maxlength='20'
                                                                             value='{$ADDRESS_COUNTRY}'></span></td>
                                                        </tr>
                                                    </table>
                                                </div>
                                            </td>
                                    ...
                                    <div class="nav-buttons">
                                        {if $SKIP_WELCOME}
                                            <input title="{$MOD.LBL_BACK}"
                                                   onclick="document.location.href='index.php?module=Configurator&action=AdminWizard&page=smtp';"
                                                   class="button"
                                        ...
                                        {else}
                                            <input title="{$MOD.LBL_WIZARD_BACK_BUTTON}"
                                                   class="button" type="button" name="next_tab1"
                                                   value="  {$MOD.LBL_WIZARD_BACK_BUTTON}  "
                                                   onclick="SugarWizard.changeScreen('welcome',true);"
                                                   id="previous_tab_welcome"/>
                                            &nbsp;
                                        {/if}
                                        <input title="{$MOD.LBL_WIZARD_NEXT_BUTTON}"
                                               class="button primary" type="button" name="next_tab1"
                                ...
                                <div id="locale" class="screen">
                                            ...
                                            <td>
                                                <div class="edit view">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td align="left" scope="row" colspan="4">
                                                                <i>{$MOD.LBL_WIZARD_LOCALE_DESC}</i></td>
                                                        </tr>
                                                        <tr>
                                                            <td scope="row" nowrap="nowrap">
                                                                <span>{$MOD.LBL_TIMEZONE}:</span>&nbsp;{sugar_help text=$MOD.LBL_TIMEZONE_TEXT }
                                                            </td>
                                                            <td colspan="3"><span><select tabindex='14'
                                                                                          name='timezone'>{html_options options=$TIMEZONEOPTIONS selected=$TIMEZONE_CURRENT}</select></span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td width="17%" scope="row" nowrap="nowrap">
                                                                <span>{$MOD.LBL_DATE_FORMAT}:</span>&nbsp;{sugar_help text=$MOD.LBL_DATE_FORMAT_TEXT }
                                                            </td>
                                                            <td width="33%"><span><select tabindex='14'
                                                                                          name='dateformat'>{$DATEOPTIONS}</select></span>
                                                            </td>
                                                            <td scope="row" nowrap="nowrap"><span>{$MOD.LBL_TIME_FORMAT}:</span>&nbsp;{sugar_help text=$MOD.LBL_TIME_FORMAT_TEXT }
                                                            </td>
                                                            <td><span><select tabindex='14'
                                                                              name='timeformat'>{$TIMEOPTIONS}</select></span>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td width="17%" scope="row" nowrap="nowrap">
                                                                <span>{$MOD.LBL_CURRENCY}:</span>&nbsp;{sugar_help text=$MOD.LBL_CURRENCY_TEXT }
                                                            </td>
                                                            <td><span>
                                    <select tabindex='14' id='currency_select' name='currency'
                                            onchange='setSymbolValue(this.selectedIndex);setSigDigits();'>{$CURRENCY}</select>
                                    ...
                                    <input type="text" disabled id="sigDigitsExample" name="sigDigitsExample">
                                                        ...
                                                        <tr>
                                                            <td width="17%" scope="row" nowrap="nowrap">
                                                                <span>{$MOD.LBL_DECIMAL_SEP}:</span>&nbsp;{sugar_help text=$MOD.LBL_DECIMAL_SEP_TEXT }
                                                            </td>
                                                            <td><span>
                                    <input tabindex='14' name='dec_sep' id='default_decimal_seperator'
                                           ...
                                           onkeydown='setSigDigits();' onkeyup='setSigDigits();'>
                                                            ...
                                                            <td width="17%" scope="row" nowrap="nowrap">
                                                                <span>{$MOD.LBL_NUMBER_GROUPING_SEP}:</span>&nbsp;{sugar_help text=$MOD.LBL_NUMBER_GROUPING_SEP_TEXT }
                                                            </td>
                                                            <td><input tabindex='14' name='num_grp_sep'
                                                                       id='default_number_grouping_seperator'
                                                                       type='text' maxlength='1' size='1'
                                                                       value='{$NUM_GRP_SEP}'
                                                                       onkeydown='setSigDigits();'
                                                                       onkeyup='setSigDigits();'></td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="4">
                                                                <hr/>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td nowrap="nowrap" scope="row"
                                                                valign="top">{$MOD.LBL_LOCALE_DEFAULT_NAME_FORMAT}:&nbsp;{sugar_help text=$smarty.capture.SMARTY_LOCALE_NAME_FORMAT_DESC }</td>
                                                            <td><span><select id="default_locale_name_format"
                                                                              tabindex='14'
                                                                              name="default_locale_name_format"
                                                                              selected="{$default_locale_name_format}">{$NAMEOPTIONS}</select></span>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                                            ...
                                            <td>
                                                <div class="edit view">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <th align="left" scope="row" colspan="4">
                                                                <h2>{$MOD.LBL_WIZARD_FINISH_TITLE}</h2></th>
                                                        </tr>
                                                        <tr>
                                                            <td scope="row">
                                                                <h3>{$MOD.LBL_WIZARD_FINISH1}</h3>

                                                                <table cellpadding=0 cellspacing=0><input id='whatnext'
                                                                                                          name='whatnext'
                                                                                                          type="hidden"
                                                                                                          value='finish'/>
                                                                    {if $IS_ADMIN}
                                                                        <tr>
                                                                            <td><img src=include/images/start.png
                                                                                     style="margin-right: 5px;"></td>
                                                                            <td>
                                                                                <a onclick='document.UserWizard.whatnext.value="finish";document.UserWizard.submit()'
                                                                                   href="#"><b> {$MOD.LBL_WIZARD_FINISH2}  </b></a><br> {$MOD.LBL_WIZARD_FINISH2DESC}
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td colspan=2>
                                                                        ...
                                                                        <tr>
                                                                            <td><img src=include/images/import.png
                                                                                     style="margin-right: 5px;"></td>
                                                                            <td>
                                                                                <a onclick='document.UserWizard.whatnext.value="import";document.UserWizard.submit()'
                                                                                   href="#"><b> {$MOD.LBL_WIZARD_FINISH3} </b></a><br> {$MOD.LBL_WIZARD_FINISH4}
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td colspan=2>
                                                                        ...
                                                                        <tr>
                                                                            <td><img src=include/images/create_users.png
                                                                                     style="margin-right: 5px;"></td>
                                                                            <td>
                                                                                <a onclick='document.UserWizard.whatnext.value="users";document.UserWizard.submit()'
                                                                                   href="#"><b> {$MOD.LBL_WIZARD_FINISH5} </b></a><br>{$MOD.LBL_WIZARD_FINISH6}
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td colspan=2>
                                                                        ...
                                                                        <tr>
                                                                            <td><img src=include/images/settings.png
                                                                                     style="margin-right: 5px;"></td>
                                                                            <td>
                                                                                <a onclick='document.UserWizard.whatnext.value="settings";document.UserWizard.submit()'
                                                                                   href="#"><b> {$MOD.LBL_WIZARD_FINISH7} </b></a><br>{$MOD.LBL_WIZARD_FINISH8}
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td colspan=2>
                                                                        ...
                                                                        <tr>
                                                                            <td><img src=include/images/configure.png
                                                                                     style="margin-right: 5px;"></td>
                                                                            <td>
                                                                                <a onclick='document.UserWizard.whatnext.value="studio";document.UserWizard.submit()'
                                                                                   href="#"><b> {$MOD.LBL_WIZARD_FINISH9} </b></a><br>{$MOD.LBL_WIZARD_FINISH10}
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td colspan=2>
                                                                        ...
                                                                        <tr>
                                                                            <td><img src=include/images/university.png
                                                                                     style="margin-right: 5px;"></td>
                                                                            <td><a href="https://community.suitecrm.com"
                                                                                   target="_blank"><b> {$MOD.LBL_WIZARD_FINISH11} </b></a></b>
                                                                                <br>{$MOD.LBL_WIZARD_FINISH12}</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td colspan=2>
                                                                                <hr style="margin: 5px 0px;">
                                                                    ...
                                                                    {else}
                                                                        <tr>
                                                                            <td><img src=include/images/university2.png
                                                                                     style="margin-right: 5px;"></td>
                                                                            <td><a href="https://community.suitecrm.com"
                                                                                   target="_blank"><b> {$MOD.LBL_WIZARD_FINISH11} </b></a></b>
                                                                                <br>{$MOD.LBL_WIZARD_FINISH12}</td>
                                                                        ...
                                                                        <tr>
                                                                            <td><img src=include/images/docs.png
                                                                                     style="margin-right: 5px;"></td>
                                                                            <td>
                                                                                <a href="https://docs.suitecrm.com/user/"
                                                                                   target="_blank"><b> {$MOD.LBL_WIZARD_FINISH14} </b></a></b>
                                                                                <br>{$MOD.LBL_WIZARD_FINISH15}</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td colspan=2>
                                                                                <hr style="margin: 5px 0px;">
                                                                        ...
                                                                        <tr>
                                                                            <td><img src=include/images/forums.png
                                                                                     style="margin-right: 5px;"></td>
                                                                            <td>
                                                                                <a href="https://community.suitecrm.com/"
                                                                                   target="_blank"><b> {$MOD.LBL_WIZARD_FINISH18} </b></a></b>
                                                                                <br>{$MOD.LBL_WIZARD_FINISH19}</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td colspan=2>
                                                                                <hr style="margin: 5px 0px;">
                    ...
                    <div id="testOutboundDialog" class="yui-hidden">
						...
						{$APP.LBL_REQUIRED_SYMBOL}
                                        ...
                                        <td>
                                            <input type="text" id="outboundtest_from_address"
                                                   name="outboundtest_from_address" size="35" maxlength="64" value="">
                                        </td>
                                    </tr>
                                    <tr>
