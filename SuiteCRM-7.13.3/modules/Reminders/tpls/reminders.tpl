...
{literal}
    <style type="text/css">
        #reminders #reminder_view .col {
            float: left;
            padding-right: 15px;
        }

        #reminders #reminder_view .btns {
            float: left;
        }
    </style>
{/literal}
...
<div style="display:none;">
    ...
    {if !$REMINDERS_DISABLED}
        <div id="reminder_template">
            ...
            <div class="col">
                <input type="checkbox" class="popup_chkbox"
                       onclick="Reminders.onPopupChkboxClick(this);"><label>{$MOD.LBL_REMINDERS_POPUP}</label>&nbsp;
            ...
            <div class="col">
                <input type="checkbox" class="email_chkbox"
                       onclick="Reminders.onEmailChkboxClick(this);"><label>{$MOD.LBL_REMINDERS_EMAIL}</label>&nbsp;
                <!-- <label>{$MOD.LBL_REMINDERS_WHEN}</label> -->
            ...
            <div class="btns">
                <button class="add-btn btn btn-info" type="button"
                        onclick="Reminders.onAddAllClick(this); return false;">
                    <span class="suitepicon suitepicon-action-plus"></span>
                    {$MOD.LBL_REMINDERS_ADD_ALL_INVITEES}
                </button>
                <button class="remove-reminder-btn btn btn-danger" type="button"
                        onclick="Reminders.onRemoveClick(this); return false;">
    ...
    {else}
        <div id="reminder_template">
            ...
            <div class="col">
                ...
                <select tabindex="0" class="timer_sel_popup" disabled="disabled"
                        style="-webkit-appearance: none; -webkit-border-radius: 0px; border: none;">
            ...
            <div class="col">
                ...
                <!-- <span>{$MOD.LBL_REMINDERS_WHEN}</span> -->
                <span type="text" class="reminder_when_value"/></span>
                <select tabindex="0" class="timer_sel_email" disabled="disabled"
                        style="-webkit-appearance: none; -webkit-border-radius: 0px; border: none;">
                    {html_options options=$reminder_time_options}
                </select>
            </div>
...
<div id="reminders">
        ...
        {if $REMINDERS_DISABLED}
            ...
            {foreach from=$remindersData item=reminder}
                <ul class="reminder_item" data-reminder-id="{$reminder.id}">
                    ...
                    <div class="col">
                        <input type="checkbox" class="popup_chkbox"
                               disabled="disabled"{if $reminder.popup} checked="checked"{/if}><span>{$MOD.LBL_REMINDERS_POPUP}</span>&nbsp;
                        <!-- <span>{$MOD.LBL_REMINDERS_WHEN}</span> -->
                        <span type="text" class="reminder_when_value"/></span>
                        <select tabindex="0" class="timer_sel_popup" disabled="disabled"
                                style="-webkit-appearance: none; -webkit-border-radius: 0px; border: none;">
                    ...
                    <div class="col">
                        <input type="checkbox" class="email_chkbox"
                               disabled="disabled"{if $reminder.email} checked="checked"{/if}><span>{$MOD.LBL_REMINDERS_EMAIL}</span>&nbsp;
                        <!-- <span>{$MOD.LBL_REMINDERS_WHEN}</span> -->
                        <span type="text" class="reminder_when_value"/></span>
                        <select tabindex="0" class="timer_sel_email" disabled="disabled"
                                style="-webkit-appearance: none; -webkit-border-radius: 0px; border: none;">
                        ...
                        <ul class="invitees_list disabled">
                            {foreach from=$reminder.invitees item=invitee}
                                <li class="invitees_item">
                                    <button class="invitee_btn btn btn-danger" data-invitee-id="{$invitees.id}"
                                            data-id="{$invitee.module_id}" data-module="{$invitee.module}"
                                            disabled="disabled">
    ...
    {if !$REMINDERS_DISABLED}
        <button id="reminder_add_btn" class="add-btn btn btn-info" type="button"
                onclick="Reminders.onAddClick(this);return false">
            <span class="suitepicon suitepicon-action-plus"></span>
...
{if $remindersDataJson && $remindersDefaultValuesDataJson && $remindersDisabled}
    ...
    {literal}
        <script type="text/javascript">
            ...
            $(function () {
                Reminders.loadDefaultsAndInit({/literal}{$remindersDataJson}, {$remindersDefaultValuesDataJson}, {$remindersDisabled}{literal}, '{/literal}{$module}{literal}', [{
                    'personModule': '{/literal}{$returnModule}{literal}',
                    'personModuleId': '{/literal}{$returnId}{literal}'
                }], '{/literal}{$returnAction}{literal}');
            });
...
{else}
    ...
    {literal}
        <script type="text/javascript">
            ...
            $(function () {
                Reminders.loadDefaultsAndInit(null, null, null, '{/literal}{$module}{literal}', [{
                    'personModule': '{/literal}{$current_user->module_dir}{literal}',
                    'personModuleId': '{/literal}{$current_user->id}{literal}',
                    'personName': '{/literal}{$current_user->name}{literal}'
                }, {
                    'personModule': '{/literal}{$returnModule}{literal}',
                    'personModuleId': '{/literal}{$returnId}{literal}'
                }], '{/literal}{$returnAction}{literal}');
