    ...
    <tr>
        <td>
            ...
            <table cellspacing="2">
                ...
                <tr>
                    <td colspan="3">
                        <input type="button" class="button primary" value="{$MOD.LBL_BTN_SAVE}" id="renameSaveBttn"
                               onclick='validateForm();' name="{$MOD.LBL_BTN_SAVE}"/>
                        <input type="button" class="button" value="{$MOD.LBL_BTN_CANCEL}" id="renameCancelBttn"
                               name="{$MOD.LBL_BTN_CANCEL}"
        ...
        <span id='slot{$rowCounter}b'>
            ...
            &nbsp;
            <span id='slot{$rowCounter}_value'
                  onclick='prepChangeDropDownValue({$rowCounter}, this);'>{$value.lang}</span>
            <span id='slot{$rowCounter}_textspan' style='display:none;'>{$value.user_lang}
                <table style="margin-left:15px;">
                    <tr>
                        <td align="right">{$MOD.LBL_SINGULAR}</td>
                        <td align="left"><input id='slot{$rowCounter}_stext' value="{$value.singular}"
                                                onchange='setSingularDropDownValue({$rowCounter});' type='text'></td>
                    </tr>
                    <tr>
                        <td align="right">{$MOD.LBL_PLURAL}</td>
                        <td align="left"><input id='slot{$rowCounter}_text' value="{$value.lang}" type='text'
                                                onchange='setDropDownValue({$rowCounter}, this.value, true)'></td>
                    </tr>
                </table>
