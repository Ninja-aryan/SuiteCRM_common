...
<form id="ConfigureSettings" name="ConfigureSettings" enctype='multipart/form-data' method="POST"
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
        ...
        <tr id="enable_portal_row">
            ...
            <td>
                <input type='checkbox' id='enable_portal' name='enable_portal'
                       {if $config.enable_portal}checked='checked'{/if} >
            </td>
    ...
    <table id='distribution_settings' width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
        <tr>
            <th align="left" scope="row" colspan="4"><h4>{$MOD.LBL_AOP_CASE_ASSIGNMENT}</h4></th>
        </tr>
        <tr>
            <td scope="row" width="200">{$MOD.LBL_AOP_DISTRIBUTION_METHOD}:</td>
            <td>
                <select id='distribution_method_select' name='distribution_method'
                        tabindex='241'>{$DISTRIBUTION_METHOD}</select>
            </td>
        </tr>
        ...
        <tr id="distribution_user_row">
            ...
            <td>
                <input type="text" name="distribution_user_name" class="sqsEnabled" tabindex="0"
                       id="distribution_user_name" size="" value="{$distribution_user_name}" title=''
                       autocomplete="off">
                <input type="hidden" name="distribution_user_id" id="distribution_user_id"
                       value="{$config.distribution_user_id}">
                <span class="id-ff multiple">
<button type="button" name="btn_distribution_user_name" id="btn_distribution_user_name" tabindex="0" title="Select User"
        class="button firstChild" value="Select User"
        {literal}
        onclick='open_popup(
                "Users",
                600,
    ...
    {/literal}
    <span class="suitepicon suitepicon-action-select"></span></button><button type="button"
                                                                              name="btn_clr_distribution_user_name"
                                                                              id="btn_clr_distribution_user_name"
                                                                              tabindex="0" title="Clear User"
                                                                              class="button lastChild"
                                                                              onclick="SUGAR.clearRelateField(this.form, 'distribution_user_name', 'distribution_user_id');"
                                                                              value="Clear User"><span
                                class="suitepicon suitepicon-action-clear"></span></button>
</span>
                <script type="text/javascript">
                    {literal}
    ...
    <table id='case_status_settings' width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
        ...
        <tr>
            <td>
                <button type='button' id="addStatusButton">{$MOD.LBL_AOP_ADD_STATUS}</button>
            </td>
        </tr>
    </table>
    <table id='email_settings' width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
        ...
        <tr>
            ...
            <td>
                <input type="text" name="support_from_address" id="support_from_address"
                       value="{$config.support_from_address}"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="inbound_email_case_macro" id="inbound_email_case_macro"
                       value="{$inbound_email_case_macro}">
                <span>
        ...
        <tr id="user_email_template_row">
            ...
            <td>
                <select id='user_email_template_id_select' name='user_email_template_id'
                        onchange='show_edit_template_link(this);'>{$USER_EMAIL_TEMPLATES}</select>
        ...
        <tr id="contact_email_template_row">
            ...
            <td>
                <select id='contact_email_template_id_select' name='contact_email_template_id'
                        onchange='show_edit_template_link(this);'>{$CONTACT_EMAIL_TEMPLATES}</select>

                <a href='javascript:open_email_template_form("contact_email_template_id")'>{$MOD.LBL_CREATE_EMAIL_TEMPLATE}</a>
                <span name='edit_template' id='contact_email_template_id_edit_template_link'
        ...
        <tr id="case_creation_email_template_row">
            ...
            <td>
                <select id='case_creation_email_template_id_select' name='case_creation_email_template_id'
                        onchange='show_edit_template_link(this);'>{$CREATION_EMAIL_TEMPLATES}</select>

                <a href='javascript:open_email_template_form("case_creation_email_template_id")'>{$MOD.LBL_CREATE_EMAIL_TEMPLATE}</a>
                <span name='edit_template' id='case_creation_email_template_id_edit_template_link'
                      style='visibility: hidden;'>
        ...
        <tr id="case_closure_email_template_row">
            ...
            <td>
                <select id='case_closure_email_template_id_select' name='case_closure_email_template_id'
                        onchange='show_edit_template_link(this);'>{$CLOSURE_EMAIL_TEMPLATES}</select>

                <a href='javascript:open_email_template_form("case_closure_email_template_id")'>{$MOD.LBL_CREATE_EMAIL_TEMPLATE}</a>
                <span name='edit_template' id='case_closure_email_template_id_edit_template_link'
                      style='visibility: hidden;'>
        ...
        <tr id="joomla_account_creation_email_template_row">
            ...
            <td>
                <select id='joomla_account_creation_email_template_id_select'
                        name='joomla_account_creation_email_template_id'
                        onchange='show_edit_template_link(this);'>{$JOOMLA_EMAIL_TEMPLATES}</select>

                <a href='javascript:open_email_template_form("joomla_account_creation_email_template_id")'>{$MOD.LBL_CREATE_EMAIL_TEMPLATE}</a>
                <span name='edit_template' id='joomla_account_creation_email_template_id_edit_template_link'
                      style='visibility: hidden;'>
