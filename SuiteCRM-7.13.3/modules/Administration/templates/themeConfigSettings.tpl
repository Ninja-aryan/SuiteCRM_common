...
<form name="themeConfigSettings" method="POST">
        ...
        <tr>
            <td>
                <input title="{$APP.LBL_SAVE_BUTTON_LABEL}" accessKey="{$APP.LBL_SAVE_BUTTON_TITLE}"
                       class="button primary" onclick="document.themeConfigSettings.do.value='save';" type="submit"
                       name="save_button" value="{$APP.LBL_SAVE_BUTTON_LABEL}">
                <input title="{$APP.LBL_CANCEL_BUTTON_LABEL}" accessKey="{$APP.LBL_CANCEL_BUTTON_KEY}" class="button"
                       onclick="document.themeConfigSettings.action.value='ThemeSettings';" type="submit"
        ...
        <table id="themeSettings" class="list view" style='margin-bottom:0;' border="0" cellspacing="0" cellpadding="0">
            ...
            {foreach from=$config key=name item=def}
                <tr>
                    ...
                    <td>
                        {if $def.type == 'colour'}
                            <input type="text" id="{$name}" name="{$name}" class="color" value="{$def.value}"
                                   size="15"/>
    ...
    <table border="0" cellspacing="1" cellpadding="1" class="actionsContainer">
        <tr>
            <td>
                <input title="{$APP.LBL_SAVE_BUTTON_LABEL}" class="button primary"
                       onclick="document.themeConfigSettings.do.value='save';" type="submit" name="save_button"
                       value="{$APP.LBL_SAVE_BUTTON_LABEL}">
                <input title="{$APP.LBL_CANCEL_BUTTON_LABEL}" class="button"
                       onclick="document.themeSettings.action.value='';" type="submit" name="cancel_button"
