...
<style>.yui-dt-scrollable .yui-dt-bd {
        ldelim
    }
                ...
                <tr>
                    <td>
                        <input title="{$APP.LBL_SAVE_BUTTON_TITLE}" accessKey="{$APP.LBL_SAVE_BUTTON_KEY}"
                               class="button primary" onclick="SUGAR.saveShortcutBar();" type="button" name="button"
                ...
                <tr>
                    <td>
                        <input title="{$APP.LBL_SAVE_BUTTON_TITLE}" class="button primary"
                               onclick="SUGAR.saveShortcutBar();" type="button" name="button"
                               value="{$APP.LBL_SAVE_BUTTON_LABEL}">
