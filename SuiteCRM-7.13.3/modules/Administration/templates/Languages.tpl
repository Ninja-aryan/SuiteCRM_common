        ...
        <td colspan='100'>
            ...
            <form name="ConfigureLangs" method="POST" method="POST" action="index.php">
                    ...
                    <tr>
                        <td>
                            <input title="{$APP.LBL_SAVE_BUTTON_TITLE}" accessKey="{$APP.LBL_SAVE_BUTTON_KEY}"
                                   ...
                                   onclick="SUGAR.saveConfigureLangs();this.form.action.value='SaveLanguages'; "
                ...
                <div class='add_table' style='margin-bottom:5px'>
                    <table id="ConfigureLangs" class="themeSettings edit view" style='margin-bottom:0px;' border="0"
