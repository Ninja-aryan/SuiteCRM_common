    ...
    <ul class="nav nav-tabs">
        ...
        *}
        ...
        <li id="tab-actions" class="dropdown">
            <a class="dropdown-toggle" data-toggle="dropdown" href="#">{{$APP.LBL_LINK_ACTIONS}}<span
                        class="suitepicon suitepicon-action-caret"></span></a>
                    ...
                    <div class="panel panel-default tab-panel-{{$tabCount}}" style="display: block;">
                        ...
                        <div class="panel panel-default tab-panel-{{$tabCount}}" style="display: none;">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body {{$collapse}} panelContainer" id="{{$panelId}}"
                                     data-id="{{$label_upper}}">
                                    <div class="tab-content">
                                        <!-- TAB CONTENT -->
                                        {{include file='themes/SuiteP/include/DetailView/tab_panel_content.tpl'}}
