...
(function (win, doc, undefined) {
    ...
    RG.Effects.Common.expand = function () {
        ...
        if (bounce) {
            ...
            jQuery('#' + obj.id).animate({
                ...
                jQuery('#' + obj.id).animate({
                    width: (obj.canvas.width * 0.9) + 'px',
                    height: (obj.canvas.height * 0.9) + 'px',
                    top: (obj.canvas.height * 0.05) + 'px',
                    left: (obj.canvas.width * 0.05) + 'px'
    ...
    RG.Effects.Common.conceal = function () {
        ...
        jQuery('#rgraph_conceal_right_' + obj.id).animate({
            left: '-=' + (obj.canvas.width / 2),
            width: (obj.canvas.width / 2)
        }, duration);
        ...
        jQuery('#rgraph_conceal_bottom_' + obj.id).animate({
            top: '-=' + (obj.canvas.height / 2),
            height: (obj.canvas.height / 2)
        }, duration);
    ...
    RG.Effects.Common.hscissorsopen =
        RG.Effects.Common.hScissorsOpen = function () {
            ...
            for (var i = 0; i < 5; ++i) {
                ...
                if (i % 2 == 0) {
                    jQuery('#' + 'rgraph_hscissors_' + i + '_' + obj.id).animate({
                        left: xy[0] + obj.canvas.width + 'px',
                        width: 0
                    }, duration);
                } else {
    ...
    RG.Effects.Common.vScissorsOpen =
        RG.Effects.Common.vscissorsopen = function () {
            ...
            for (var i = 0; i < 10; ++i) {
                ...
                if (i % 2 == 0) {
                    jQuery('#' + 'rgraph_vscissors_' + i + '_' + obj.id).animate({
                        top: xy[1] + obj.canvas.height + 'px',
                        height: 0
                    }, duration);
                } else {
