            ...
            if (prop['chart.ylabels'] && prop['chart.ylabels.specific'] == null) {
                ...
                if (prop['chart.noxaxis'] == true
                    ...
                    RG.Text2(this, {
                        ...
                        'size': text_size,
                        'x': xpos,
                        'y': prop['chart.xaxispos'] == 'top' ? this.gutterTop : (ca.height - this.gutterBottom),
                        'text': prop['chart.units.pre'] + Number(0).toFixed(prop['chart.scale.decimals']) + prop['chart.units.post'],
                        'valign': 'center',
                        'halign': align,
                        'bounding': bounding,
                        'boundingFill': bgcolor,
