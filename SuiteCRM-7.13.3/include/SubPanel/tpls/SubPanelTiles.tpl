    ...
    {foreach from=$subpanel_tabs key=i item=subpanel_tab}
        <li class="noBullet" id="whole_subpanel_{$subpanel_tab}">
            ...
            <div cookie_name="{$subpanel_tabs_properties.$i.cookie_name}" id="subpanel_{$subpanel_tab}"
                 style="display:{$subpanel_tabs_properties.$i.div_display}">
                ...
                {if $tabs_properties.$i.div_display != 'none'}
                    <script>SUGAR.util.doWhen("typeof(markSubPanelLoaded) != 'undefined'", function () {literal}{
                            markSubPanelLoaded('{/literal}{$subpanel_tab}{literal}');
                        }{/literal});</script>
