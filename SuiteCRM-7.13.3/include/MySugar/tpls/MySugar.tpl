    ...
    <tr>
        <td>
                ...
                {foreach from=$dashboardPages key=tabNum item=tab}
                    ...
                    <li id="pageNum_{$tabNum}">
                        ...
                        {if !$lock_homepage}<a id="removeTab_anchor"  onClick="removeDashboardForm({$tabNum});"><span
                                    class="suitepicon suitepicon-action-clear"></span></a>{/if}
                ...
                {if !$lock_homepage}
                    <li class="addButton">
                        <a style='cursor: pointer;'
                           onclick="return SUGAR.mySugar.showDashletsDialog();">{$lblAddDashlets}</a>
                    </li>
                    <li class="addButton">
            ...
            <script type="text/javascript">
                ...
                $(function () {
                    if (SUGAR.ajaxUI && SUGAR.ajaxUI.hist_loaded == false) {
                        retrievePage(0)
                    }
                    ;
                });
