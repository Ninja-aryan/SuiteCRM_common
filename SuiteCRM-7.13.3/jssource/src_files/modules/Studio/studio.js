    ...
    if (on) {
        field.onmouseover = function () {
            ...
            $(this).tipTip({
                maxWidth: "auto",
                edgeOffset: 10,
                content: document.getElementById(this.id + 'b').innerHTML
            });
...
SUGAR.Studio.prototype.endLabelEdit = function (id) {
    ...
    jstransaction.record('studioLabelEdit', {
        'id': id,
        'new': document.getElementById(id).value,
        'old': document.getElementById('label' + id).innerHTML
    });
...
SUGAR.Studio.prototype.save = function (formName, publish) {
    ...
    var cObj = YAHOO.util.Connect.asyncRequest('POST', 'index.php',
        {
            success: SUGAR.Studio.prototype.saved,
            failure: SUGAR.Studio.prototype.saved,
            timeout: 5000,
            argument: publish
        });
}
    ...
    return {
        ...
        render: function (obj) {
            if (obj) {
                ...
                studiojs.popup = new YAHOO.widget.Dialog("dlg", {
                    effect: {
