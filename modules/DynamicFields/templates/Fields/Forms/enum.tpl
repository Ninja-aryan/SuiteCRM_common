    ...
    <td>
        {if $hideLevel < 5 && empty($vardef.function)}
            ...
            <input type='button' value='{sugar_translate module="DynamicFields" label="LBL_BTN_EDIT"}' class='button'
                   onclick="{literal}if(check_form('popup_form')) { ModuleBuilder.moduleDropDown(this.form.options.value, this.form.options.value); }{/literal}">
...
<tr>
    ...
    <td>
        ...
        {else}
            <input type='hidden' name='default[]' id='default[]' value='$vardef.default'>
            {$vardef.default}
        {/if}
    </td>
</tr>
