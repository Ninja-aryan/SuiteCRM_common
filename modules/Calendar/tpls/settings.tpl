        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <form name="settings" id="form_settings" method="POST"
                          action="index.php?module=Calendar&action=SaveSettings">

                        <div class="panel panel-default ">
                            <div class="panel-heading  panel-heading-collapse">
                                <a id="subpanel_title_activities" class="" role="button" data-toggle="collapse"
                                   href="#subpanel_settings_settings">
                                ...
                                <table class='table-responsive'>
                                    <tr>
                                        ...
                                        <td width="45%">
                                            ...
                                            <input type="checkbox" id="display_timeslots" name="display_timeslots"
                                                   {if $display_timeslots}checked{/if} value="1" tabindex="102"
                                                   onchange="toggleDisplayTimeslots();">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td scope="row" valign="top" width="55%">
                                        ...
                                        <td width="45%">
                                            ...
                                            <input type="checkbox" id="shared_calendar_separate"
                                                   name="shared_calendar_separate"
                                                   {if $shared_calendar_separate}checked{/if} value="1" tabindex="102">
                                        </td>
                                    </tr>
                                    <tr class="time_range_options_row">
                                        ...
                                        <td>
                                            <div id="d_start_time_section">
                                                <select size="1" id="day_start_hours" name="day_start_hours"
                                                        tabindex="102">
                                                    {$TIME_START_HOUR_OPTIONS}
                                                </select>&nbsp;:

                                                <select size="1" id="day_start_minutes" name="day_start_minutes"
                                                        tabindex="102">
                                    ...
                                    <tr class="time_range_options_row">
                                        ...
                                        <td>
                                            <div id="d_end_time_section">
                                                ...
                                                <select size="1" id="day_end_minutes" name="day_end_minutes"
                                                        tabindex="102">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select size="1" name="show_calls" tabindex="102">
                                                ...
                                                <option value='true'
                                                        {if $show_calls}selected{/if}>{$MOD.LBL_YES}</option>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <select size="1" name="show_tasks" tabindex="102">
                                                ...
                                                <option value='true'
                                                        {if $show_tasks}selected{/if}>{$MOD.LBL_YES}</option>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <select size="1" name="show_completed" tabindex="102">
                                                <option value=''
                                                        {if !$show_completed}selected{/if}>{$MOD.LBL_NO}</option>
                                                <option value='true'
                                                        {if $show_completed}selected{/if}>{$MOD.LBL_YES}</option>
                                            </select>
                                        </td>
                                    </tr>
                                ...
                                <table class="table-responsive">
                                    ...
                                    {foreach from=$activity key=name item=def}
                                        <tr>
                                            <td>{$def.label}</td>
                                            <td>
                                                <input type="text" id="{$name}" name="activity[{$name}][body]"
                                                       class="color" value="{$def.body}" size="8"/>
                                            </td>
                                            <td>
                                                <input type="text" id="{$name}" name="activity[{$name}][border]"
                                                       class="color" value="{$def.border}" size="8"/>
                                            </td>
                                            <td>
                                                <input type="text" id="{$name}" name="activity[{$name}][text]"
                                                       class="color" value="{$def.text}" size="8"/>
                                            </td>
                                        </tr>
                                    {/foreach}
                                </table>
            ...
            <div class="modal-footer">
                ...
                <button id="btn-save-settings" onclick="$('#form_settings).submit();" class="btn btn-danger"
