        ...
        <tr>
            <td align="left" style="padding-bottom: 2px;">
                <input title="{$APP.LBL_SAVE_BUTTON_TITLE}" accessKey="{$APP.LBL_SAVE_BUTTON_KEY}" class="button"
                       type="submit"
                       name="button" {$saveOnclick|default:"onclick=\"return check_form('NotesQuickCreate');\""}
                ...
                <input title="{$APP.LBL_FULL_FORM_BUTTON_TITLE}" accessKey="{$APP.LBL_FULL_FORM_BUTTON_KEY}"
                       ...
                       onclick="this.form.to_pdf.value='0';this.form.action.value='EditView'; this.form.module.value='Notes';"
            ...
            <td>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td><span><textarea name='description' tabindex='1' cols="75" rows="6">{$DESCRIPTION}</textarea></span>
                        </td>
                    </tr>
                </table>
            </td>
