...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
        ...
        <td align='right'>
            ...
            <span style="{$DISABLE_LINK}"><input type="button" class="button" id="view_roi_button"
                                                 onclick="javascript:window.location='index.php?module=Campaigns&action=RoiDetailView&record={$ID}';"
                                                 value="{$MOD.LBL_TRACK_ROI_BUTTON_LABEL}"/></SPAN>{$ADMIN_EDIT}
        </td>
...
<table border='0' width='100%'>
    ...
    <tr>
        <td colspan="3">
            <div class="reportChartContainer">{$MY_CHART}</div>
        </td>
    </tr>
</table>
</form>
