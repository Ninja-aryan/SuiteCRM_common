...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="list view">
    ...
    {foreach from=$top_campaigns item="campaign"}
        <tr>
            ...
            <td class="oddListRowS1" align="left" valign="top" width="74%"><a
                        href="index.php?module=Campaigns&action=DetailView&record={$campaign.campaign_id}">{$campaign.campaign_name}</a>
            </td>
