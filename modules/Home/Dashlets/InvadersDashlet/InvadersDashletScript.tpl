                            ...
                            if (count[0] == 0) {
                                if (count[1] == 0) {
                                    if (count[2] == 0) {
                                        if (count[3] == 0) {
                                            if (count[4] == 0) {
                                                InvadersGame.nextLevel();
                                            } else {
                                                InvadersGame.leftRowsCleared = 32 * 4;
                                            }
                                        } else {
                                            InvadersGame.leftRowsCleared = 32 * 3;
                                        }
                                    } else {
                                        InvadersGame.leftRowsCleared = 32 * 2;
                                    }
                                } else {
                                    InvadersGame.leftRowsCleared = 32;
                                }
                            } else {
                                InvadersGame.leftRowsCleared = 0;
                            }
                            ...
                            if (count[4] == 0) {
                                if (count[3] == 0) {
                                    if (count[2] == 0) {
                                        if (count[1] == 0) {
                                            if (count[0] == 0) {
                                                InvadersGame.rightRowsCleared = 32 * 5;
                                            } else {
                                                InvadersGame.rightRowsCleared = 32 * 4;
                                            }
                                        } else {
                                            InvadersGame.rightRowsCleared = 32 * 3;
                                        }
                                    } else {
                                        InvadersGame.rightRowsCleared = 32 * 2;
                                    }
                                } else {
                                    InvadersGame.rightRowsCleared = 32;
                                }
                            } else {
                                InvadersGame.rightRowsCleared = 0;
                            }
