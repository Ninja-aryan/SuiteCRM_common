...
<form enctype="multipart/form-data" name="importstep2" method="POST" action="index.php" id="importstep2">
                ...
                <table border="0" cellspacing="0" cellpadding="0" width="100%">
                    ...
                    <tr>
                        <td align="left" scope="row" colspan="3">
                            <div><label for="userfile">{$MOD.LBL_SELECT_FILE}</label></div>
                            <div><input type="hidden"/><input size="20" id="userfile" name="userfile"
                                                              type="file"/>{sugar_help text=$MOD.LBL_FILE_UPLOAD_WIDGET_HELP}
                            </div>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
            <td align="left">
                {if $displayBackBttn}
                    <input title="{$MOD.LBL_BACK}" class="button" type="submit" name="button"
                           value="  {$MOD.LBL_BACK}  " id="goback">
                    &nbsp;
                {/if}
