<form id="ConfigureSettings" name="ConfigureSettings" enctype='multipart/form-data' method="POST"
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
        <tr>
            <th align="left" scope="row" colspan="4"><h4>{$MOD.LBL_AOS_ADMIN_CONTRACT_SETTINGS}</h4></th>
        <tr>
            <td scope="row" width="200">{$MOD.LBL_AOS_ADMIN_CONTRACT_RENEWAL_REMINDER}:</td>
            <td>
                <input type='number' size='10' name='aos_contracts_renewalReminderPeriod'
                       value='{$config.aos.contracts.renewalReminderPeriod}'> <span>{$MOD.LBL_AOS_DAYS}</span>
            </td>
        </tr>
    </table>
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
        <tr>
            <th align="left" scope="row" colspan="4"><h4>{$MOD.LBL_AOS_ADMIN_INVOICE_SETTINGS}</h4></th>
        </tr>
        <tr>
            <td scope="row" width="200">{$MOD.LBL_AOS_ADMIN_INITIAL_INVOICE_NUMBER}:</td>
            <td>
                <input type='number' size='10' name='aos_invoices_initialNumber'
                       value='{$config.aos.invoices.initialNumber}'>
            </td>
        </tr>
    </table>
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
        <tr>
            <th align="left" scope="row" colspan="4"><h4>{$MOD.LBL_AOS_ADMIN_QUOTE_SETTINGS}</h4></th>
        </tr>
        <tr>
            <td scope="row" width="200">{$MOD.LBL_AOS_ADMIN_INITIAL_QUOTE_NUMBER}:</td>
            <td>
                <input type='number' size='10' name='aos_quotes_initialNumber'
                       value='{$config.aos.quotes.initialNumber}'>
            </td>
        </tr>
    </table>
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
        <tr>
            <th align="left" scope="row" colspan="4"><h4>{$MOD.LBL_AOS_ADMIN_LINE_ITEM_SETTINGS}</h4></th>
        </tr>
        <tr>
