    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td>
                ...
                <table id="sysGeneratedId" name="sysGeneratedName" width="100%" border="0" cellspacing="1"
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input name='passwordsetting_SystemGeneratedPasswordON'
                                   id='SystemGeneratedPassword_checkbox' type='checkbox'
                                   value='1' {$SystemGeneratedPasswordON}
                    ...
                    <tr>
                        <td colspan='4'>
                            <table width="100%" id='syst_generated_pwd_table' border="0" cellspacing="1"
                                   cellpadding="0">
                                <tr>
                                    ...
                                    {/if}
                                    <td width='30%'>
                                        <input type="radio" name="passwordsetting_systexpiration"
                                               value='0' {$systexpnone}
                                    ...
                                    <td width='30%'>
                                        <input type="radio" name="passwordsetting_systexpiration"
                                               id="required_sys_pwd_exp_time" value='1' {$systexptime}
                                        ...
                                        <input type='text' maxlength="3" and style="width:2em"
                                               name='passwordsetting_systexpirationtime'
                                    ...
                                    <td colspan='2' width='40%'>
                                        <input type="radio" name="passwordsetting_systexpiration"
                                               id="required_sys_pwd_exp_login" value='2' {$systexplogin}
                ...
                <table id="userResetPassId" name="userResetPassName" width="100%" border="0" cellspacing="1"
                    ...
                    <tr>
                        ...
                        <td scope="row" width="25%">
                            ...
                            <input name="passwordsetting_forgotpasswordON" id="forgotpassword_checkbox" value="1"
                        ...
                        <td colspan="3">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="forgot_password_table">
                                <tr>
                                    ...
                                    {/if}
                                    <td width='30%'>
                                        <input type="radio" name="passwordsetting_linkexpiration"
                                               value='0' {$linkexpnone}
                                    ...
                                    <td width='30%'>
                                        <input type="radio" name="passwordsetting_linkexpiration"
                                               id="required_link_exp_time" value='1' {$linkexptime}>
                    ...
                    <tr>
                        ...
                        <td scope="row" width="75%"><input type='hidden' name='captcha_on' value='0'><input
                                    name="captcha_on" id="captcha_id" value="1" class="checkbox" tabindex='1'
                                    type="checkbox"
                        ...
                        <td colspan="4">
                            <div id="captcha_config_display" style="display:{$CAPTCHA_CONFIG_DISPLAY}">
                                <table width="100%" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="10%" scope="row">{$MOD.LBL_PUBLIC_KEY}<span class="required">*</span>
                                        </td>
                                        <td width="40%"><input type="text" name="captcha_public_key"
                                                               id="captcha_public_key" size="45"
                                                               value="{$settings.captcha_public_key}" tabindex='1'
                                                               onblur="this.value=this.value.replace(/^\s+/,'').replace(/\s+$/,'')">
                                        </td>
                                        <td width="10%" scope="row">{$MOD.LBL_PRIVATE_KEY}<span
                    ...
                    <tr>
                        ...
                        <td>
										        <span>
													...
													<input type="button" value="{$MOD.LBL_PASSWORD_EDIT_TEMPLATE}"
                                                           class="button"
                                                           onclick="javascript:edit_email_template_form('generatepasswordtmpl')"
                                                           name='edit_generatepasswordtmpl'
                                                           id='edit_generatepasswordtmpl' style="{$EDIT_TEMPLATE}">
												</span>
                        </td>
                        <td></td>
                        <td></td>
                    ...
                    <tr>
                        ...
                        <td>
							        			<span>
													...
													<input type="button" class="button"
                                                           onclick="javascript:open_email_template_form('lostpasswordtmpl')"
                                                           value="{$MOD.LBL_PASSWORD_CREATE_TEMPLATE}" {$IE_DISABLED}>
													<input type="button" value="{$MOD.LBL_PASSWORD_EDIT_TEMPLATE}"
                                                           class="button"
                                                           onclick="javascript:edit_email_template_form('lostpasswordtmpl')"
                        ...
                        <td>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    ...
                                    <td valign='middle'><input name="system_ldap_enabled" id="system_ldap_enabled"
                                                               class="checkbox"
                                ...
                                <tr>
                                    <td colspan='4'>
                                        <table cellspacing='0' cellpadding='1' id='ldap_display'
                                               style='display:{$ldap_display}' width='100%'>
                                            <tr>
                                                ...
                                                <td width='25%' align="left" valign='top'><input name="ldap_hostname"
                                                                                                 size='25' type="text"
                                                                                                 value="{$settings.ldap_hostname}">
                                                </td>
                                                <td width='25%' scope="row" valign='top'
                                                    nowrap>{$MOD.LBL_LDAP_SERVER_PORT} {sugar_help text=$MOD.LBL_LDAP_SERVER_PORT_DESC}</td>{$settings.proxy_port}
                                                <td width='25%' align="left" valign='top'><input name="ldap_port"
                                                                                                 size='6' type="text"
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" valign='middle'><input name="ldap_base_dn" size='35'
                                                                                        type="text"
                                                                                        value="{$settings.ldap_base_dn}">
                                                </td>
                                                <td scope="row" valign='middle'
                                                    nowrap>{$MOD.LBL_LDAP_USER_FILTER} {sugar_help text=$MOD.LBL_LDAP_USER_FILTER_DESC}</td>
                                                <td align="left" valign='middle'><input name="ldap_login_filter"
                                                                                        size='25' type="text"
                                                                                        value="{$settings.ldap_login_filter}">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td scope="row" valign='top'
                                                    nowrap>{$MOD.LBL_LDAP_BIND_ATTRIBUTE} {sugar_help text=$MOD.LBL_LDAP_BIND_ATTRIBUTE_DESC}</td>
                                                <td align="left" valign='top'><input name="ldap_bind_attr" size='25'
                                                                                     type="text"
                                                                                     value="{$settings.ldap_bind_attr}">
                                                </td>
                                                <td scope="row" valign='middle'
                                                    nowrap>{$MOD.LBL_LDAP_LOGIN_ATTRIBUTE} {sugar_help text=$MOD.LBL_LDAP_LOGIN_ATTRIBUTE_DESC}</td>
                                                <td align="left" valign='middle'><input name="ldap_login_attr" size='25'
                                                                                        type="text"
                                                                                        value="{$settings.ldap_login_attr}">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td scope="row" valign='top'
                                                ...
                                                <td align="left" valign='top'>
                                                    ...
                                                    <input name="ldap_group_checkbox" class="checkbox"
                                                           type="checkbox" {$ldap_group_checked}
																	...
																	<table width='100%'>
																		<tr>
																			...
																			<td width='25%' align="left"
                                                                                valign='top'><input name="ldap_group_dn"
                                                                                                    size='20'
                                                                                                    type="text"
                                                                                                    value="{$settings.ldap_group_dn}"></td>
																			<td width='25%' scope="row" valign='top'
                                                                                nowrap>{$MOD.LBL_LDAP_GROUP_NAME} {sugar_help text=$MOD.LBL_LDAP_GROUP_NAME_DESC}</td>
																			<td width='25%' align="left"
                                                                                valign='top'><input
                                                                                        name="ldap_group_name" size='20'
                                                                                        type="text"
                                                                                        value="{$settings.ldap_group_name}"></td>
																		</tr>
																		<tr>
																			<td scope="row" valign='top'
																		...
																		<tr>
                                                                            ...
                                                                            {/if}
																			<input name="ldap_group_attr_req_dn"
                                                                                   class="checkbox"
                                                                                   type="checkbox" {$ldap_group_attr_req_dn}> </td>
																		</tr>
																	</table>
																 <br>
																</span>
																...
																<table width='100%'>
																	<tr>
																		...
																		<td width='25%' align="left" valign='top'><input
                                                                                    ...
                                                                                    type="text"
                                                                                    value="{$settings.ldap_admin_user}"></td>
																		<td width='25%' scope="row" valign='middle'
                                                                            nowrap>{$MOD.LBL_LDAP_ADMIN_PASSWORD}</td>
																		<td width='25%' align="left"
                                                                            valign='middle'><input
                                                                                    name="ldap_admin_password" size='20'
                                                                                    type="password"
                                                                                    value="{$settings.ldap_admin_password}"> </td>
																	</tr>
																</table>
																<br>
															</span>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" valign='top'><input type='hidden'
                                                                                     ...
                                                                                     value='0'><input
                                                            name="ldap_auto_create_users" value="1" class="checkbox"
                                                            type="checkbox" {$ldap_auto_create_users_checked}></td>
                                                <td valign='middle' nowrap></td>
                                                <td align="left" valign='middle'></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="left" valign='middle'><input name="ldap_enc_key" size='35'
                                                                                        type="password"
                    ...
                    <tr>
                        <td>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td colspan='4'>
                                        <table cellspacing='0' cellpadding='1' id='saml_display'
                                               style='display:{$saml_display}' width='100%'>
                                            <tr>
                                                <td scope="row" valign='middle'
                                                    nowrap>{$MOD.LBL_SAML_LOGIN_URL} {sugar_help text=$MOD.LBL_SAML_LOGIN_URL_DESC}</td>
                                                <td align="left" valign='middle'><input name="SAML_loginurl" size='35'
                                                                                        type="text"
                                                                                        value="{$config.SAML_loginurl}">
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" valign='middle'><input name="SAML_logouturl" size='35'
                                                                                        type="text"
                                                                                        value="{$config.SAML_logouturl}">
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td width='25%' align="left" valign='top'><textarea
                                                            style='height:200px;width:600px'
                                                            name="SAML_X509Cert">{$config.SAML_X509Cert}</textarea></td>
