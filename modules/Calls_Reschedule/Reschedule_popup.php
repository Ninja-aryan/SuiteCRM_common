...
<div id="dialog1" class="yui-pe-content">
    ...
    <div class="bd">
        <form method="POST" action="index.php?module=Calls&action=Reschedule">
            ...
            <br/>
            <span id="error1"
                  style="color: #ff0000;display: none;"><?php echo $app_strings['LBL_RESCHEDULE_ERROR1']; ?></span>
            <br/>
            ...
            <br/>
            <span id="error2"
                  style="color: #ff0000;display: none;"><?php echo $app_strings['LBL_RESCHEDULE_ERROR2']; ?></span>
        </form>
    </div>
</div>
