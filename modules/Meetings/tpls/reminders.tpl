...
{if $view == "EditView" || $view == "QuickCreate" || $view == "QuickEdit"}
    <div>
        ...
        <input name="reminder_checked" id="reminder_checked" onclick="toggleReminder(this,'reminder');" type="checkbox"
               class="checkbox" value="1" {$REMINDER_CHECKED}>
    ...
    <div>
        ...
        <input name="email_reminder_checked" id="email_reminder_checked"
               onclick="toggleReminder(this,'email_reminder');" type="checkbox" class="checkbox"
               value="1" {$EMAIL_REMINDER_CHECKED}>
