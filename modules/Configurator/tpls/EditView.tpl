...
<form name="ConfigureSettings" enctype='multipart/form-data' method="POST" action="index.php"
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
        ...
        <tr>
            ...
            {/if}
            <td><input type='hidden' name='calculate_response_time' value='false'><input name='calculate_response_time'
                                                                                         type="checkbox"
                                                                                         value="true" {$calculate_response_time_checked}>
            </td>
        ...
        <tr>
            ...
            <td scope="row" width='15%' nowrap>{$MOD.LBL_MIN_AUTO_REFRESH_INTERVAL}
                &nbsp;{sugar_help text=$MOD.LBL_MIN_AUTO_REFRESH_INTERVAL_HELP} </td>
            <td width='35%'>
                <select name='dashlet_auto_refresh_min'
                        id='dashlet_auto_refresh_min'>{$AUTO_REFRESH_INTERVAL_OPTIONS}</select>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><a href="./index.php?module=Administration&action=ConfigureAjaxUI"
                   id="configure_ajax">{$MOD.LBL_CONFIG_AJAX}</a>&nbsp;{sugar_help text=$MOD.LBL_CONFIG_AJAX_DESC}</td>
        </tr>

        <tr>
            <td scope="row" nowrap>{$MOD.LBL_DISALBE_CONVERT_LEAD}:
                &nbsp;{sugar_help text=$MOD.LBL_DISALBE_CONVERT_LEAD_DESC}</td>
        ...
        <tr>
            <td scope="row" nowrap>{$MOD.LBL_ENABLE_ACTION_MENU}:
                &nbsp;{sugar_help text=$MOD.LBL_ENABLE_ACTION_MENU_DESC}</td>
        ...
        <tr>
            <td scope="row" nowrap>{$MOD.LBL_ENABLE_INLINE_EDITING_LIST}:
                &nbsp;{sugar_help text=$MOD.LBL_ENABLE_INLINE_EDITING_LIST_DESC}</td>
            ...
            <td scope="row" nowrap>{$MOD.LBL_ENABLE_INLINE_EDITING_DETAIL}:
                &nbsp;{sugar_help text=$MOD.LBL_ENABLE_INLINE_EDITING_DETAIL_DESC}</td>
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
        ...
        <tr>
            ...
            {/if}
            <td width="75%" align="left" valign='middle' colspan='3'><input type='hidden' name='proxy_on'
                                                                            value='0'><input name="proxy_on"
                                                                                             id="proxy_on" value="1"
                                                                                             class="checkbox"
                                                                                             tabindex='1'
                                                                                             type="checkbox" {$proxy_on_checked}
            ...
            <td colspan="4">
                <div id="proxy_config_display" style='display:{$PROXY_CONFIG_DISPLAY}'>
                    <table width="100%" cellpadding="0" cellspacing="1">
                        <tr>
                            <td width="15%" scope="row">{$MOD.LBL_PROXY_HOST}<span
                                        class="required">{$APP.LBL_REQUIRED_SYMBOL}</span></td>
                            <td width="35%"><input type="text" id="proxy_host" name="proxy_host" size="25"
                                                   value="{$settings.proxy_host}" tabindex='1'></td>
                            <td width="15%" scope="row">{$MOD.LBL_PROXY_PORT}<span
                                        class="required">{$APP.LBL_REQUIRED_SYMBOL}</span></td>
                            <td width="35%"><input type="text" id="proxy_port" name="proxy_port" size="6"
                                                   value="{$settings.proxy_port}" tabindex='1'></td>
                        </tr>
                        <tr>
                            ...
                            {/if}
                            <td width="35%" align="left" valign='middle'><input type='hidden' name='proxy_auth'
                                                                                value='0'><input id="proxy_auth"
                                                                                                 name="proxy_auth"
                                                                                                 value="1"
                                                                                                 class="checkbox"
                                                                                                 tabindex='1'
                                                                                                 type="checkbox" {$proxy_auth_checked}
                    ...
                    <div id="proxy_auth_display" style='display:{$PROXY_AUTH_DISPLAY}'>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="1">
                            <tr>
                                <td width="15%" scope="row">{$MOD.LBL_PROXY_USERNAME}<span
                                            class="required">{$APP.LBL_REQUIRED_SYMBOL}</span></td>

                                <td width="35%"><input type="text" id="proxy_username" name="proxy_username" size="25"
                                                       value="{$settings.proxy_username}" tabindex='1'></td>
                                <td width="15%" scope="row">{$MOD.LBL_PROXY_PASSWORD}<span
                                            class="required">{$APP.LBL_REQUIRED_SYMBOL}</span></td>
                                <td width="35%"><input type="password" id="proxy_password" name="proxy_password"
                                                       size="25" value="{$settings.proxy_password}" tabindex='1'></td>
                            </tr>
                        </table>
                    </div>
                </div>
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
        ...
        <tr>
            ...
            {/if}
            <td><input type='hidden' name='verify_client_ip' value='false'><input name='verify_client_ip'
                                                                                  type="checkbox"
                                                                                  value="1" {$verify_client_ip_checked}>
            </td>
            ...
            {/if}
            <td><input type='hidden' name='log_memory_usage' value='false'><input name='log_memory_usage'
                                                                                  type="checkbox"
                                                                                  value='true' {$log_memory_usage_checked}>
            </td>
        ...
        <tr>
            ...
            {/if}
            <td><input type='hidden' name='dump_slow_queries' value='false'><input name='dump_slow_queries'
                                                                                   type="checkbox"
                                                                                   value='true' {$dump_slow_queries_checked}>
            </td>
        ...
        <tr>
            ...
            {/if}
            <td><input type='hidden' name='stack_trace_errors' value='false'><input name='stack_trace_errors'
                                                                                    type="checkbox"
                                                                                    value='true' {$stack_trace_errors_checked}>
            </td>
        ...
        <tr>
            ...
            {/if}
            <td><input type='hidden' name='developerMode' value='false'><input name='developerMode' type="checkbox"
                                                                               value='true' {$developerModeChecked}>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <input type='text' size='4' name='import_max_records_total_limit'
                       value='{$config.import_max_records_total_limit}'>
            </td>
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
        {if $logger_visible}
            ...
            <tr>
                ...
                <td><select name="logger_file_suffix"
                            selected='{$config.logger.file.suffix}'>{$filename_suffix}</select></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                {/if}
                <td><input type='hidden' name='stackTrace' value='false'><input name='stackTrace' type="checkbox"
                                                                                value='true' {$stackTraceChecked}></td>
