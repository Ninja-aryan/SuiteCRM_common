...
class Jjwg_MapsViewConfig extends SugarView
{
    ...
    public function display()
    {
        ...
        <p style="margin: 15px 0px 15px 0px; font-size: 1.7em;">
            <strong><?php echo $GLOBALS['mod_strings']['LBL_CONFIG_TITLE']; ?></strong></p>

        <?php if (!empty($_REQUEST['config_save_notice'])) {
        ?>
        <p style="margin: 15px 0px 15px 0px; font-size: 1.5em;">
            <strong><?php echo $GLOBALS['mod_strings']['LBL_CONFIG_SAVED']; ?></strong></p>
        <?php
    } ?>
        ...
        <form name="settings" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            ...
            <input type="submit" class="button" tabindex="101" name="submit"
                   value="  <?php echo $GLOBALS['app_strings']['LBL_SAVE_BUTTON_LABEL']; ?>  " align="bottom">
            &nbsp;
            <input type="button" class="button" tabindex="102" name="cancel"
                   value="  <?php echo $GLOBALS['app_strings']['LBL_CANCEL_BUTTON_LABEL']; ?>  " align="bottom"
            ...
            <table class="edit view table" cellpadding="0" cellspacing="12" border="0">
                ...
                <tr>
                    ...
                    <td><a href="https://developers.google.com/maps/documentation/javascript/"
                           target="_blank"><?php echo $GLOBALS['mod_strings']['LBL_GET_GOOGLE_API_KEY']; ?></a></td>
                </tr>
                <tr>
                    <td><strong><?php echo $GLOBALS['mod_strings']['LBL_CONFIG_VALID_GEOCODE_MODULES']; ?> </strong>
                    </td>
                ...
                <tr>
                    <td><strong><?php echo $GLOBALS['mod_strings']['LBL_CONFIG_GROUP_FIELD_FOR_ACCOUNTS']; ?> </strong>
                    </td>
                ...
                <tr>
                    <td><strong><?php echo $GLOBALS['mod_strings']['LBL_CONFIG_GROUP_FIELD_FOR_CONTACTS']; ?> </strong>
                    </td>
                ...
                <tr>
                    <td><strong><?php echo $GLOBALS['mod_strings']['LBL_CONFIG_GROUP_FIELD_FOR_LEADS']; ?> </strong>
                    </td>
                ...
                <tr>
                    <td>
                        <strong><?php echo $GLOBALS['mod_strings']['LBL_CONFIG_GROUP_FIELD_FOR_OPPORTUNITIES']; ?> </strong>
                    </td>
                ...
                <tr>
                    <td><strong><?php echo $GLOBALS['mod_strings']['LBL_CONFIG_GROUP_FIELD_FOR_CASES']; ?> </strong>
                    </td>
                ...
                <tr>
                    <td><strong><?php echo $GLOBALS['mod_strings']['LBL_CONFIG_GROUP_FIELD_FOR_PROJECTS']; ?> </strong>
                    </td>
                ...
                <tr>
                    <td><strong><?php echo $GLOBALS['mod_strings']['LBL_CONFIG_GROUP_FIELD_FOR_MEETINGS']; ?> </strong>
                    </td>
                ...
                <tr>
                    <td><strong><?php echo $GLOBALS['mod_strings']['LBL_CONFIG_GROUP_FIELD_FOR_PROSPECTS']; ?> </strong>
                    </td>
                ...
                foreach ($custom_modules as $module) {
                    ...
                    <tr>
                        <td>
                            <strong><?php echo $GLOBALS['mod_strings']['LBL_CONFIG_GROUP_FIELD_FOR'] . ' ' . $module . ':'; ?> </strong>
                        </td>
                        <td><input type="text" name="grouping_field_<?php echo $module; ?>"
                                   id="grouping_field_<?php echo $module; ?>"
                ...
                <tr>
                    <td><strong><?php echo $GLOBALS['mod_strings']['LBL_CONFIG_GEOCODING_API_URL_TITLE']; ?> </strong>
                    </td>
                ...
                <tr>
                    <td>
                        <strong><?php echo $GLOBALS['mod_strings']['LBL_CONFIG_GEOCODING_API_SECRET_TITLE']; ?> </strong>
                    </td>
                ...
                <tr>
                    <td><strong><?php echo $GLOBALS['mod_strings']['LBL_CONFIG_GEOCODING_LIMIT_TITLE']; ?> </strong>
                    </td>
                ...
                <tr>
                    <td>
                        <strong><?php echo $GLOBALS['mod_strings']['LBL_CONFIG_GOOGLE_GEOCODING_LIMIT_TITLE']; ?> </strong>
                    </td>
                ...
                <tr class="row odd">
                    <td>
                        <strong><?php echo $GLOBALS['mod_strings']['LBL_CONFIG_ALLOW_APPROXIMATE_LOCATION_TYPE_TITLE']; ?> </strong>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <strong><?php echo $GLOBALS['mod_strings']['LBL_CONFIG_EXPORT_ADDRESSES_LIMIT_TITLE']; ?> </strong>
                    </td>
                ...
                <tr>
                    <td>
                        <strong><?php echo $GLOBALS['mod_strings']['LBL_CONFIG_ADDRESS_CACHE_GET_ENABLED_TITLE']; ?> </strong>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <strong><?php echo $GLOBALS['mod_strings']['LBL_CONFIG_ADDRESS_CACHE_SAVE_ENABLED_TITLE']; ?> </strong>
                    </td>
                    <td>
                ...
                <tr>
                    <td><strong><?php echo $GLOBALS['mod_strings']['LBL_CONFIG_LOGIC_HOOKS_ENABLED_TITLE']; ?> </strong>
                    </td>
                    <td>
                ...
                <tr>
                    <td><strong><?php echo $GLOBALS['mod_strings']['LBL_CONFIG_MAP_MARKERS_LIMIT_TITLE']; ?> </strong>
                    </td>
                ...
                <tr>
                    <td>
                        <strong><?php echo $GLOBALS['mod_strings']['LBL_CONFIG_MAP_DEFAULT_CENTER_LATITUDE_TITLE']; ?> </strong>
                    </td>
                ...
                <tr>
                    <td>
                        <strong><?php echo $GLOBALS['mod_strings']['LBL_CONFIG_MAP_DEFAULT_CENTER_LONGITUDE_TITLE']; ?> </strong>
                    </td>
                ...
                <tr>
                    <td>
                        <strong><?php echo $GLOBALS['mod_strings']['LBL_CONFIG_MAP_DEFAULT_UNIT_TYPE_TITLE']; ?> </strong>
                    </td>
                    <td>
                        <select id="map_default_unit_type" tabindex="153"
                                name="map_default_unit_type" title="">
                            <?php foreach ($unit_types
                ...
                <tr>
                    <td>
                        <strong><?php echo $GLOBALS['mod_strings']['LBL_CONFIG_MAP_DEFAULT_DISTANCE_TITLE']; ?> </strong>
                    </td>
                ...
                <tr>
                    <td>
                        <strong><?php echo $GLOBALS['mod_strings']['LBL_CONFIG_MAP_DUPLICATE_MARKER_ADJUSTMENT_TITLE']; ?> </strong>
                    </td>
                ...
                <tr>
                    <td>
                        <strong><?php echo $GLOBALS['mod_strings']['LBL_CONFIG_MAP_CLUSTER_GRID_SIZE_TITLE']; ?> </strong>
                    </td>
                ...
                <tr>
                    <td>
                        <strong><?php echo $GLOBALS['mod_strings']['LBL_CONFIG_MAP_MARKERS_CLUSTERER_MAX_ZOOM_TITLE']; ?> </strong>
                    </td>
            ...
            <input type="submit" class="button" tabindex="211" name="submit"
                   value="  <?php echo $GLOBALS['app_strings']['LBL_SAVE_BUTTON_LABEL']; ?>  " align="bottom">
            &nbsp;
            <input type="button" class="button" tabindex="212" name="cancel"
                   value="  <?php echo $GLOBALS['app_strings']['LBL_CANCEL_BUTTON_LABEL']; ?>  " align="bottom"
                   onclick="document.location.href='index.php?module=Administration&amp;action=index'" title="">
