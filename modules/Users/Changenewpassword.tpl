...
<script type='text/javascript'
        src='{/literal}{sugar_getjspath file="modules/Users/PasswordRequirementBox.js"}{literal}'></script>
    <style type="text/css">
        <!--
        .body {
            font-size: 12px;
                            ...
                            <table cellpadding="0" cellspacing="2" border="0" align="center" width="100%"
                                ...
                                <tr>
                                    <td colspan="2" width="100%"
                                        style="font-size: 12px; padding-bottom: 5px; font-weight: normal;">{$INSTRUCTION}</td>
                                </tr>
                                <tr>
                                    <td colspan="2" width="100%"
                                        style="font-size: 12px; padding-bottom: 5px; font-weight: normal; color: red;">{$ERRORS}</td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan='2'><span id='post_error' class="error">{$EXPIRATION_TYPE}&nbsp;</span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td width="30%">
                                        <input type="password" size="26" tabindex="2" id="new_password"
                                ...
                                <tr>
                                    ...
                                    <td width="30%">
                                        <input type="password" size="26" tabindex="2" id="confirm_pwd"
                                               name="confirm_pwd" value="" onkeyup="password_confirmation();"/>
                                        <div id="comfirm_pwd_match" class="error"
                                             style="display: none;">{$MOD.LBL_PASSWORD_MIS_MATCH}</div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>{$CAPTCHA}</td>
