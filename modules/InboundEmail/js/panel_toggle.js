...
function togglePanels(type) {
    ...
    var panelsPerType = {
        'personal': {
            ...
            'LBL_AUTO_REPLY_CONFIGURATION': false,
            'LBL_GROUP_CONFIGURATION': false,
            'LBL_CASE_CONFIGURATION': false
        },
        'group': {
            'LBL_CONNECTION_CONFIGURATION': true,
            'LBL_OUTBOUND_CONFIGURATION': true,
            'LBL_AUTO_REPLY_CONFIGURATION': true,
            'LBL_GROUP_CONFIGURATION': true,
            'LBL_CASE_CONFIGURATION': true
        },
        'bounce': {
            'LBL_CONNECTION_CONFIGURATION': true,
            'LBL_OUTBOUND_CONFIGURATION': false,
            'LBL_AUTO_REPLY_CONFIGURATION': false,
            'LBL_GROUP_CONFIGURATION': false,
            'LBL_CASE_CONFIGURATION': false
        }
