...
Studio2 = {
    ...
    unregisterExpandableField: function (field) {
        ...
        if (this.isExpandable(field)) {
            if (this.getColumnWidth(field) > 1) {
                this.reduceFieldWidth(field);
            }
    ...
    registerExpandableField: function (field) {//field = HTML element
        if (Studio2.maxColumns < 2 || field == null || typeof (field) == 'undefined' || this.isSpecial(field)) {
            return;
        }
        if (!this.isExpandable(field)) {
            ...
            if (this.isSpecial(next) || this.isSpecial(prev) || this.isEmpty(next) || this.isEmpty(prev) || removeMe == null) { //Always Expanded
                ...
                if (removeMe != null) {
                    field.parentNode.removeChild(removeMe);
                }
                var img = this.getImageElement(false);
                img.onclick = function () {
                    Studio2.toggleFieldWidth(field.id)
                };
            ...
            _write_("Could not Register field:" + field.id);
        }
    },
