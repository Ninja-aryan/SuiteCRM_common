...
<form name='edittabs' id='edittabs' method='POST' action='index.php'>
    ...
    <table id="editor-content" class="list-editor">
        ...
        <tr>
            ...
            {foreach from=$groups key='label' item='list'}
                <td id={$label}  width="30%" VALIGN="top"
                    style="float: left; border: 1px gray solid; padding:4px; margin-right:4px; margin-top: 8px;  overflow-x: hidden;">
                    <h3>{$label}</h3>
                                        ...
                                        <td align="right" colspan="2" class="percentage">
                                            {if $view|substr:-6 == "search" }
                                                <span style="display:none"
                                                      id='subslot{$modCounter}width'>{$value.width}</span>
                                                <span style="display:none">%</span>
                                            {else}
                                                <span id='subslot{$modCounter}width'>{$value.width}</span>
                                                <span>%</span>
                                            {/if}
                                        </td>
                                    </tr>
