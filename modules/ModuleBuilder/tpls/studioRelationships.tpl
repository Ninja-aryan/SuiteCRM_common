...
<script>
    ...
    'name',
        label
    :
    SUGAR.language.get('ModuleBuilder', 'LBL_REL_NAME'),
        width
    :
    200,
        sortable
    ...
    key: 'lhs_module',
        label
    :
    SUGAR.language.get('ModuleBuilder', 'LBL_LHS_MODULE'),
        width
    :
    120,
        sortable
    ...
    key: 'relationship_type',
        label
    :
    SUGAR.language.get('ModuleBuilder', 'LBL_REL_TYPE'),
        width
    :
    120,
        sortable
    ...
    key: 'rhs_module',
        label
    :
    SUGAR.language.get('ModuleBuilder', 'LBL_RHS_MODULE'),
        width
    :
    120,
        sortable
