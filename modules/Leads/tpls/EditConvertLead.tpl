...
<script>
    ...
    var getEditButton = function (el, rec, col, data) {
        ...
        YAHOO.util.Event.addListener(el, "click", function () {
            editLayout(grid.getRecord(el).getData());
        });
    }
    var getRemoveButton = function (el, rec, col, data) {
        ...
        el.innerHTML = out;
        YAHOO.util.Event.addListener(el, "click", function () {
            removeLayout(grid.getRecord(el).getData());
        });
    }
    ...
    'moduleName',
        label
    :
    '{sugar_translate label="LBL_CONVERT_MODULE_NAME"}',
        width
    :
    200,
        sortable
    ...
    key: 'required',
        label
    :
    '{sugar_translate label="LBL_CONVERT_REQUIRED"}',
        width
    :
    80,
        sortable
    ...
    key: 'copyData',
        label
    :
    '{sugar_translate label="LBL_CONVERT_COPY"}',
        width
    :
    80,
        sortable
    ...
    key: 'select',
        label
    :
    '{sugar_translate label="LBL_CONVERT_SELECT"}',
        width
    :
    80,
        sortable
    ...
    key: 'edit',
        label
    :
    '{sugar_translate label="LBL_CONVERT_EDIT"}',
        width
    :
    40,
        sortable
    ...
    key: 'delete',
        label
    :
    '{sugar_translate label="LBL_CONVERT_DELETE"}',
        width
    :
    40,
        sortable
