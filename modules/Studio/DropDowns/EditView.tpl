    ...
    <tr>
        <td>
            ...
            <table cellspacing="2">
                <tr>
                    <td valign="center">
                        <input type="button" value="{$MOD.LBL_BTN_UNDO}" onclick="jstransaction.undo()"
                               name="{$MOD.LBL_BTN_UNDO}"/>
                    </td>
                    <td valign="center">
                        <input type="button" value="{$MOD.LBL_BTN_REDO}" onclick="jstransaction.redo()"
                               name="{$MOD.LBL_BTN_REDO}"/>
                    </td>
                    <td valign="center">
                    ...
                    <td>
                        ...
                        <form method='post' action='index.php' name='editdropdown'>
                            ...
                            {else}
                                <table>
                                    <tr>
                                        ...
                                        <td>{$MOD.COLUMN_TITLE_NAME}<input type='text' name='dropdown_name'
                                                                           value='{$dropdown_name}'>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {$MOD.LBL_DROPDOWN_LANGUAGE}</td>
                                        <td>{html_options name='dropdown_lang' options=$dropdown_languages selected=$dropdown_lang}
                                        </td>
                                    </tr>
                                </table>
                            {/if}
                            <table name='tabDropdown' id='tabDropdown'>
                                <tr>
                                    <td>{$MOD.LBL_DD_DATABASEVALUE}
                                        <hr>
                                    </td>
                                    <td>{$MOD.LBL_DD_DISPALYVALUE}
                                        <hr>
                                    </td>
                                </tr>
...
{/if}
    ...
    <span id='slot{$rowCounter}_textspan' style='display:none'>
        <input id='slot{$rowCounter}_text' value='' type='text'
               onchange='setDropDownValue({$rowCounter}, this.value, true)'>
        {$value.user_lang}
    </span>
    ...
    <input type='hidden' id='delete_{$rowCounter}' name='delete_{$rowCounter}' value='0'>
                                ...
                                <tr>
                                    <td><input type='text' name='addKey' id='addKey' value=''></td>
                                    <td><input type='text' name='addValue' id='addValue' value=''><input type='button'
                                                                                                         onclick='addDropDown();'
                                                                                                         value='+'
                                                                                                         class='button'>
                                    </td>
            ...
            <script>
                ...
                function setDropDownValue(rowCount, val, record) {
                    ...
                    if (record) {
                        jstransaction.record('changeDropDownValue', {
                            'row': rowCount,
                            'new': val,
