...
<div id="settings_suitep">
    ...
    <div class="row detail-view-row">
        <div class="col-xs-12 col-sm-6 detail-view-row-item">
            ...
            <div class="col-xs-12 col-sm-8 detail-view-field">
                ...
                <input name='receive_notifications' class="checkbox" tabindex='12' type="checkbox"
                       value="12" {$RECEIVE_NOTIFICATIONS} disabled>
        ...
        <div class="col-xs-12 col-sm-6 detail-view-row-item">
            ...
            <div class="col-xs-12 col-sm-8 detail-view-field " type="name" field="name">
                <!-- simple hidden start -->
                <input tabindex='3' name='mailmerge_on' disabled class="checkbox" type="checkbox" {$MAILMERGE_ON}
                       disabled>
                <!-- simple hidden finish -->
            </div>
        </div>
        ...
        <div class="row detail-view-row">
            <div class="col-xs-12 col-sm-12 detail-view-row-item">
                ...
                <div class="col-xs-12 col-sm-10 detail-view-field " type="name" field="name">
                    <!-- simple hidden start -->
                    <input id="external_auth_only" name="external_auth_only" type="checkbox"
                           class="checkbox" {$EXTERNAL_AUTH_ONLY_CHECKED} disabled>
                    <!-- simple hidden finish -->
                </div>
            </div>
        </div>
    ...
    <div class="row detail-view-row">
        ...
        <div class="col-xs-12 col-sm-6 detail-view-row-item">
            ...
            <div class="col-xs-12 col-sm-8 detail-view-field " type="name" field="name">
                <!-- simple hidden start -->
                <input tabindex='3' name='use_real_names' disabled class="checkbox" type="checkbox" {$USE_REAL_NAMES}
                       disabled>
                <!-- simple hidden finish -->
            </div>
        </div>
...
<div id="layout_suitep">
    ...
    <div class="row detail-view-row">
        <div class="col-xs-12 col-sm-6 detail-view-row-item">
            ...
            <div class="col-xs-12 col-sm-8 detail-view-field ">
                <!-- simple hidden start -->
                <input name="use_group_tabs" type="hidden" value="m"><input id="use_group_tabs" type="checkbox"
