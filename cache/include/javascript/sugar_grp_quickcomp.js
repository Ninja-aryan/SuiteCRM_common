...
function method_callback(o) {
    var resp = JSON.parse(o.responseText), request_id = o.tId, result = resp.result;
    if (result == null) {
        return;
    }
...
SugarVCalClient.prototype.parseResults = function (textResult, adjusted, meetingDate) {
    ...
    var index = 0;
    while (((resultFREEBUSYID = matchXFREEBUSYID.exec(textResult))) != null && ((resultFREEBUSY = matchFREEBUSY.exec(textResult))) != null && ((resultFREEBUSYTYPE = matchFREEBUSYTYPE.exec(textResult))) != null) {
        var startdate;
        var enddate;
        if (adjusted) {
