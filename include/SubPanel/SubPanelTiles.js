    ...
    if (force_load || typeof (child_field_loaded[child_field]) == 'undefined') {
        ...
        $.ajax({
            ...
            success: function (data) {
                request_map[request_id] = child_field;
                var returnstuff = {"responseText": data, "responseXML": '', "request_id": request_id};
...
SUGAR.subpanelUtils = function () {
    var originalLayout = null, subpanelContents = {}, subpanelLocked = {}, currentPanelDiv;
    return {
        getLayout: function (asString, ignoreHidden) {
            ...
            function success(data) {
                var theDivObj = document.getElementById(theDiv), divName = theDiv + '_newDiv', form_el;
            ...
            var element = document.getElementById(buttonName), theForm = element.form,
