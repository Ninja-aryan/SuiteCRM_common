...
(function () {
    var subRootAttributes = tinymce.explode('id,name,style,align,class,hspace,vspace,bgcolor,type'),
        subExcludedAttrs = tinymce.makeMap(subRootAttributes.join(',')),
        rootAttributes = subRootAttributes.concat(tinymce.explode('width, height')),
