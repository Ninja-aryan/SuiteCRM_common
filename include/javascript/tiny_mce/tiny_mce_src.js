...
(function (tinymce) {
    ...
    tinymce.create('tinymce.dom.Selection', {
        ...
        moveToBookmark: function (bookmark) {
            var t = this, dom = t.dom, marker1, marker2, rng, rng2, root, startContainer, endContainer, startOffset,
                endOffset;
    ...
    tinymce.create('tinymce.ui.NativeListBox:tinymce.ui.ListBox', {
        ...
        postRender: function () {
            ...
            Event.add(t.id, 'keydown', function (e) {
                var bf, DOM_VK_LEFT = 37, DOM_VK_RIGHT = 39, DOM_VK_UP = 38, DOM_VK_DOWN = 40, DOM_VK_RETURN = 13,
                    DOM_VK_SPACE = 32;
