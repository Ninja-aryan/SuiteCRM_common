    ...
    YAHOO.extend(YAHOO.widget.Toolbar, YAHOO.util.Element, {
        ...
        _createColorPicker: function (id) {
            ...
            Event.on(picker, 'mousedown', function (ev) {
                ...
                var tar = Event.getTarget(ev);
                if (tar.tagName.toLowerCase() == 'a') {
                    var retVal = this.fireEvent('colorPickerClicked', {
        ...
        _makeColorButton: function (_oButton) {
            ...
            _oButton.type = 'color';
            _oButton.menu = new YAHOO.widget.Overlay(this.get('id') + '_' + _oButton.value + '_menu', {
                visible: false,
                position: 'absolute',
                iframe: true
            });
        ...
        _buttonClick: function (ev, info) {
            ...
            if (doEvent) {
                ...
                if (info.value) {
                    retValue = this.fireEvent(info.value + 'Click', {
                        type: info.value + 'Click',
                ...
                if (info.menucmd && fireNextEvent) {
                    retValue = this.fireEvent(info.menucmd + 'Click', {
                        type: info.menucmd + 'Click',
                        target: this.get('element'),
                        button: info
                    });
                    if (retValue === false) {
...
(function () {
    ...
    YAHOO.extend(YAHOO.widget.SimpleEditor, YAHOO.util.Element, {
        ...
        _handleDoubleClick: function (ev) {
            var ret = this.fireEvent('beforeEditorDoubleClick', {
        ...
        execCommand: function (action, value) {
            var beforeExec = this.fireEvent('beforeExecCommand', {
            ...
            if ((this.browser.webkit && !this.browser.webkit4) || (this.browser.opera)) {
                if (this._isElement(selEl, 'li') && this._isElement(selEl.parentNode, tag)) {
                    ...
                    var lis = el.getElementsByTagName('li'),
                        p_tag = ((this.browser.opera && this.get('ptags')) ? 'p' : 'div');
