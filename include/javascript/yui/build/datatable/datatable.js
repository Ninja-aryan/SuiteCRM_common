                    ...
                    if (aNewRecords) {
                        ...
                        // Not paginated
                            ...
                            this._oChainRender.add({
                                ...
                                argument: {
                                    nCurrentRow: startIndex,
                                    aRecords: aNewRecords,
                                    nDataPointer: 0,
                                    isAdding: isAdding
                                },
                                scope: this,
        ...
        unhighlightCell: function (cell) {
            ...
            if (elCell) {
                ...
                this.fireEvent("cellUnhighlightEvent", {
                    record: oRecord,
                    column: this.getColumn(this.getCellIndex(elCell)),
                    key: this.getColumn(this.getCellIndex(elCell)).getKey(),
                    el: elCell
                });
                return;
            }
...
/////////////////////////////////////////////////////////////////////////////
        ...
        renderForm: function () {
            ...
            if (YAHOO.widget.Calendar) {
                ...
                // Bug 2528576
                calendar.hideEvent.subscribe(function () {
                    this.cancel();
                }, this, true);
