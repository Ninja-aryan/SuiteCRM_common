...
<div class="col-xs-12">
    <div class="col-xs-12 email-address-add-line-container emailaddresses" id="{$module}emailAddressesTable{$index}">
        ...
        <button type="button" class="btn btn-danger email-address-add-button"
        ...
        <div class="col-xs-12 template email-address-line-container hidden">
            <div class="col-xs-12 col-sm-6  email-address-input-container {if $module == "Users"} email-address-users-profile{/if}">
                <div class="input-group email-address-input-group">
                    <input type="email" id="email-address-input" class="form-control" placeholder="email@example.com"
                           title="{$app_strings.LBL_EMAIL_TITLE}">
					...
					<button type="button" id="email-address-remove-button"
                            class="btn btn-danger email-address-remove-button" name=""
                            title="{$app_strings.LBL_ID_FF_REMOVE_EMAIL}">
            ...
            <div class="col-xs-12 col-sm-6 email-address-options-container">
                ...
                <div class="col-xs-3 col-sm-2 col-md-2 col-lg-2 text-center email-address-option">
                    ...
                    <div><input type="radio" name="" id="email-address-primary-flag" class="email-address-primary-flag"
                                value="" enabled="true" tabindex="0" checked="true"
                                title="{$app_strings.LBL_EMAIL_PRIM_TITLE}"></div>
                </div>

                {if $useReplyTo == true}
                    <div class="col-xs-3 col-sm-2 col-md-2 col-lg-2 text-center email-address-option">
                        <label class="text-sm  col-xs-12">{$app_strings.LBL_EMAIL_REPLY_TO}</label>
                        <div><input type="checkbox" name="" id="email-address-reply-to-flag"
                                    class="email-address-reply-to-flag" value="" enabled="true"></div>
                    </div>
                {/if}
                ...
                {if $useOptOut == true}
                    <div class="col-xs-3 col-sm-2 col-md-2 col-lg-2 text-center email-address-option">
                        ...
                        <div><input type="checkbox" name="" title="{$app_strings.LBL_ID_FF_OPT_OUT}"
                                    id="email-address-opt-out-flag" class="email-address-opt-out-flag" value=""
                                    enabled="true"></div>
                    </div>
                {/if}
                ...
                {if $useInvalid == true}
                    <div class="col-xs-3 col-sm-2 col-md-2 col-lg-2 text-center email-address-option">
                        ...
                        <div><input type="checkbox" name="" title="{$app_strings.LBL_EMAIL_INVALID}"
                                    id="email-address-invalid-flag" class="email-address-invalid-flag" value=""
                                    enabled="true"></div>
                    </div>
                {/if}
                    ...
                    <div class="col-xs-3 col-sm-2 col-md-2 col-lg-2 text-center email-address-option">
                        ...
                        <div>
                            ...
                            <input type="checkbox" name="" title="{$app_strings.LBL_OPT_IN}"
                                   id="email-address-opted-in-flag" class="email-address-opted-in-flag" value=""
                                   enabled="true">
                        </div>
                    </div>
                {/if}
