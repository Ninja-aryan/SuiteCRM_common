...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
    ...
    <tr>
        ...
        <td class="sumbitButtons">
            {/if}
            <input tabindex='2' title='{$APP.LBL_SEARCH_BUTTON_TITLE}' onclick='submitSearch("{$subpanel}");'
                   class='button' type='button' name='search' id='search_form_search'
                   value='{$APP.LBL_SEARCH_BUTTON_TITLE}'/>
            <input tabindex='2' title='{$APP.LBL_CLEAR_BUTTON_TITLE}' onclick='clearSearch("{$subpanel}");'
