    ...
    <table border="0" cellspacing="1" cellpadding="0" class="edit" width="100%">
        <tr>
            ...
            <td width="*">
                ...
                <textarea id="{{$street}}" name="{{$street}}" title='{{$vardef.help}}'
        ...
        <tr>
            ...
            <td>
                <input type="text" name="{{$city}}" id="{{$city}}" title='{$fields.{{$city}}.help}'
        ...
        <tr>
            ...
            <td>
                <input type="text" name="{{$state}}" id="{{$state}}" title='{$fields.{{$state}}.help}'
                       size="{{$displayParams.size|default:30}}"
        ...
        <tr>
            ...
            <td>
                <input type="text" name="{{$postalcode}}" id="{{$postalcode}}" title='{$fields.{{$postalcode}}.help}'
                       size="{{$displayParams.size|default:30}}"
        ...
        <tr>
            ...
            <td>
                <input type="text" name="{{$country}}" id="{{$country}}" title='{$fields.{{$country}}.help}'
                       size="{{$displayParams.size|default:30}}"
