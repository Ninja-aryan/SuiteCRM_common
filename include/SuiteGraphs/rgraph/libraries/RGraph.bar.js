            ...
            if (prop['chart.xaxispos'] == 'center') {
                ...
                if (this.scale2.min != 0 || prop['chart.scale.zerostart']) {
                    RG.Text2(this, {
                        ...
                        'size': text_size,
                        'x': xpos,
                        'y': this.gutterTop + this.halfgrapharea,
                        'text': RGraph.number_format(this, (this.scale2.min.toFixed((prop['chart.scale.decimals']))), units_pre, units_post),
                        'valign': 'center',
                        'valign': 'center',
                        'halign': align,
                        'bordered': boxed,
    ...
    this.waveOld = function () {
        ...
        function iterator(idx, frames) {
            if (frame[idx] <= frames) {
                ...
                ++frame[idx];
                RG.Effects.updateCanvas(function () {
                    iterator(idx, frames);
                });
